---
title: "KOLEKTIVNI UGOVOR ZA DRUŠTVO AUTOTRANS d.o.o. RIJEKA"
identifier: "HR-NN-2010-23-572"
country: "hr"
rank: "otro"
publication_date: "2010-02-19"
last_updated: "2010-02-19"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2010/23/572"
...
AUTOTRANS d.o.o. RIJEKA, Trg Žabica 1, zastupan po predsjedniku Uprave Zvonku Krmpotiću dipl. oec., (u daljnjem tekstu: POSLODAVAC)

i

SINDIKAT RADNIKA AUTOTRANS, TRG ŽABICA 1 RIJEKA, zastupan po predsjedniku Romanu Pužaru (u daljnjem tekstu: SINDIKAT)

sklopili su 21. prosinca 2009. g.

KOLEKTIVNI UGOVOR

ZA DRUŠTVO AUTOTRANS d.o.o. RIJEKA
...
Poslodavac može sklopiti jedan ili više uzastopnih ugovora o radu na određeno vrijeme u razdoblju ne dužem od tri godine ukoliko je to nužno zbog potrebe organizacije posla poslodavca.
...
Poslodavac će svojom odlukom utvrdit opće i posebne uvjete za zasnivanje radnog odnosa, kao i mijenjati utvrđene uvjete (opće i posebne) za postojeća radna mjesta, ovisno o potrebama organizacije posla i uvođenju novog informacijskog sustava.
...
Poslodavac će omogućiti radniku, u skladu sa potrebama posla, obrazovanje, stručno osposobljavanje i usavršavanje.
...
Puno ili nepuno radno vrijeme ne mora biti raspoređeno jednako po tjednima, te se u tom slučaju puno ili nepuno radno vrijeme utvrđuje kao prosječno tjedno radno vrijeme unutar razdoblja od četiri mjeseca, pri čemu odstupanje od punog radnog vremena iz članka 11 stavak 1 ovog kolektivnog ugovora ne smije iznositi više od 12 sati mjesečno.

U slučaju iz prethodnog stavka ovog članka radnik može raditi najviše 48 sati tjedno.

Ako je istekom razdoblja iz stavka 2 ovog članka prosječno tjedno radno vrijeme bilo duže od punog odnosno nepunog radnog vremena, rad duži od punog odnosno nepunog radnog vremena smatra se prekovremenim radom.
...
Preraspodijeljeno radno vrijeme uključujući i prekovremeni rad ne smije biti duže od 48 sati tjedno.

Za poslove sezonske naravi kao i poslove koje odredi Poslodavac preraspodijeljeno radno vrijeme ne smije biti duže od 56 sati tjedno, uz pisanu izjavu radnika o pristanku na rad duži od 48 sati tjedno.

Poslodavac je dužan obavijestiti radnike o preraspodijeli radnog vremena najmanje tjedan dana unaprijed.

Preraspoređeno radno vrijeme može trajati najduže 6 mjeseci.

O preraspodjeli radnog vremena Poslodavac će s Radničkim vijećem sklopiti posebni pisani Sporazum.

### Članak 14.

Ako potrebe poslodavca, priroda i opseg posla odnosno organizacija poslodavca to zahtijeva, ugovor o radu sa radnikom može se sklopiti i za nepuno radno vrijeme.
...
Za prekovremeni rad radnice - trudnice, majke s djetetom do tri godine, samohranog roditelja do šest godina starosti potrebna I radnika koji radi u neponom radnom vremenu potrebna je njihova pismena izjava o dobrovoljnom pristanku na takav rad, osim u slučaju više sile.

U slučajevima iz stavka 1 ovog članka radnik je obvezan raditi prekovremeno najviše 8 sati tjedno.

Prekovremeni rad pojedinog radnika ne smije trajati duže od 32 sata mjesečno niti duže od 180 sati godišnje.

O hitnom prekovremenom radu poslodavac je dužan izvjestiti radnika najkasnije jedan dan unaprijed. U slučajevima kada je prekovremeni rad prijeko potreban radi dovršenja procesa rada čije se trajanje nije moglo predvidjeti, a čiji bi prekid nanio znatniju materijalnu štetu i zamjene radnika u procesu rada u neprekidnom trajanju, i u drugim slučajevima, radnik je obvezan raditi prekovremeno bez prethodne obavijesti.
...
Kada je prijeko potrebno da radnik radi nedjeljom, korištenje dana neiskorištenih tjednih odmora omogućit će mu se tijekom dva sljedeća tjedna.
...
U dane godišnjeg odmora ne uračunavaju se dani određeni Pravilnikom o radu Poslodavca.
...
Ako radnik želi koristiti godišnji odmor u dijelovima, prvi dio u trajanju od dva tjedna neprekidno, mora koristiti tijekom kalendarske godine za koju ostvaruje pravo na godišnji odmor.
...
sa radnikom živi u vanbračnoj zajednici,
djeteta (bračnog, vanbračnog i usvojenog),
roditelja i posvojitelja 5 dana

• smrti brata, sestre, roditelja bračnog druga 3 dana

• smrti djeda i bake, te osobe s kojim
...
obrazovanja za potrebe radničkog
...
– pridržavati se početka i završetka radnog vremena utvrđenog odlukom Poslodavca. Početkom radnog vremana smatra se vremenom kada radnik mora biti nazočan na radnom mjestu, te spreman za početak rada. Napuštanje mjesta rada dopušteno je samo uz znanje i dozvolu neposrednog rukovoditelja.
...
Poslovi i radni zadaci grupirani su u IX grupa.

Odnos između osnovne bruto plaće najniže i najviše vrednovanih poslova ne može biti manji od 1:3,5.

### Članak 30.

Osnovica za obračun osnovne bruto plaće iznosi 1.590,00 kuna, i ista se množi s koeficijentom složenosti radnog mjesta koji je utvrđen u prilogu br. 1 ovog kolektivnog ugovora Tarifnim razredima.
...
Vrijednost boda utvrđuje Uprava Društva uz suglasnost Sindikata temeljem ostvarenih rezultata poslovanja organizacione cjeline, poslovne jedinice odnosno društva u cjelini.
...
a) za rad noću (od 22-6 h) 30%

b) za rad u dane tjednog odmora 35%

c) za rad u dane blagdana i neradnih
dana utvrđenih zakonom 50%

d) za rad duži od punog radnog vremena
(prekovremeni rad) po pismenom nalogu
Direktora sektora I Rukovoditelja PJ 35%
...
f) za rad voznog osoblja u lokalu, kada se zbog
režima vožnje ostvaruju 2 i više prekida dužih
od jednog sata između dvije linije, a dnevna
zauzetost je duža od 10 sati (tzv. lomljeno
radno vrijeme) osnovna plaća za efektivne
sate povećava se za 20%

g) vozaču koji pored redovnog radnog zadatka
izvrši i neku drugu dodatnu vožnju osnovna plaća
za dodatno izvršeni zadatak povećava se za 20%

Ovo se uvećanje vozaču priznaje uz ispunjenje
dva uvjeta:

– da je redovnim dnevnim zadatkom ostvario
najmanje 8 sati rada

– da je unaprijed utvrđen dnevni obrtaj vozila
(raspored po linijama)
...
Dodatak iz ad a) noćni rad, osim na sate vožnje i plaćenu stanku obračunava se i na pripremu i raspremu, ukoliko se uklapa u interval od 22 sata do 6.00 sati.

### Članak 36.

Radniku koji obavlja mjenjačke poslove, pripada dodatak na plaću u visini od 0,1% ostvarenog bruto prometa s tim, da dodatak po ovom osnovu ne može iznositi više od 15% za redovan rad.
...
c) za prenošenje prtljage od vlaka, broda ili aviona do autobusa odnosno obratno, ako je to sa korisnikom prijevoza posebno ugovoreno i naplaćeno, voznom osoblju pripada naknada od 1,00 kn po putniku.
...
Radnicima se priznaju troškovi prijevoza na posao i s posla prema uvjetima utvrđenim Pravilnikom o radu Poslodavca.
...
U tom slučaju radniku će se nadoknaditi troškovi u visini iznosa predviđenmog važećim zakonskim propisima.
...
Radniku će se isplatiti i iznos od 250,00 kn bruto za svaku navršenu godinu neprekidnog rada kod poslodavca.
...
– bolovanje u neprekidnom trajanju dužem od
90 dana, jednom u tijeku 12 mjeseci, pod
uvjetom da radnik nije pod otkaznim rokom 2.500,00 kn
...
Radnik može od Poslodavca primiti dar za dijete koje do 31-og prosinca tekuće godine nije navršilo 15 godina starost, kao i prigodnu nagradu i/ili dar u naravi prema odluci Poslodavca.
...
U slučaju redovitog otkaza poslodavca radniku otkazni rok ovisi o neprekidnom radnom stažu kod istog poslodavca i sukladan je onom propisanom važećim Zakonom o radu.
...
Pisane odluke o ostvarivanju prava i obveza iz radnog odnosa radnika neposredno se uručuju radniku putem neposrednog rukovoditelja u zatvorenoj omotnici sa povratnicom, a ako to nije moguće dostavljaju se preporučenom pošiljkom na posljednju adresu o kojoj je radnik obavijestio poslodavcu. Ukoliko radnik odbije primitak preporučene pošiljke na svojoj posljednjoj prijavljenoj adresi poslodavcu, ili pismeno - pošiljka bude vraćeno poslodavcu sa napomenom da je radnik obaviješten o prispjeću istog ali ga nije preuzeo, pismeno će se izvjesiti na oglasnu ploču Društva i smatrat će se da je dostava uredno izvršena.
...
Odredba stavka 1 ovog članka ne odnosi se na radnika koji je štetu uzrokovao kaznenim djelom sa umišljajem.

X. ZABRANA TAKMIČENJA RADNIKA S POSLODAVCEM

### Članak 60.

Radnik za vrijeme trajanja radnog odnosa kod poslodavca nema pravo obavljati poslove za svoj ili tuđi račun koji su konkurentni sa djelatnošću poslodavca.
...
Za rješavanje kolektivnih radnih sporova između potpisnika ovog ugovora o sklapanju, izmijeni ili obnovi kolektivnog ugovora ili drugog sličnog spora koje nije bilo moguće riješiti međusobnim pregovaranjem, mora se provesti postupak mirenja.

### Članak 67.

Postupak mirenja provodi osoba koju potpisnici ovog ugovora izaberu s liste koju utvrđuje Gospodarsko-socijalno vijeće, a vodi se pri Županijskom uredu Županije primorsko-goranske nadležnom za poslove rada ili koji sporazumno odrede (miritelj).
...
I FAZA – poslovi koji se ne smiju prekidati –
TRAJANJE FAZE 7 DANA.

1. Međunarodne autobusne linije,

2. Međužupanijske autobusne linije,

3. Županijske autobusne linije za otoke Krk, Cres, Lošinj, Pag, Rab, Brač i Korčula

4. Prijevozi koji se obavljaju temeljem sklopljenih ugovora s Ministarstvom obrane, Županijama i Gradovima – prijevoz učenika osnovnog i srednjeg obrazovanja,

5. Radione:

– PJ Servis 1 automehaničar i 1 autoelektričar u smjeni

– Ostale PJ 1 automehaničar po smjeni

6. Poslovne jedinice

– 1 prometnik po smjeni

7. Autobusni kolodvori i prodajna mjesta
...
– Direktori sektora i Rukovoditelji službi

II. FAZA – poslovi koji se ne smiju prekidati
TRAJANJE OD 8 DO 14 DANA.

1. Međunarodne linije

2. Međužupanijske linije

– PULA – RIJEKA – DUBROVNIK (jedna linija odnosno polazak i povratak)

– RIJEKA – SPLIT (dvije linije odnosno 2 polaska i 2 povratka)

– RIJEKA – ZAGREB (dvije linije odnosno 2 polaska i 2 povratka)

– ROVINJ – PULA – ZAGREB (dvije linije odnosno 2 polaska i 2 povratka)

– POREČ – ZAGREB (jedna linija odnosno polazak i povratak)

– otoci KRK, CRES,LOŠINJ, RAB (jedna linija za svaki otok odnosno polazak PAG – ZAGREB i povratak)

– NOVI VINODOLSKI – ZAGREB (jedna linija odnosno polazak i povratak)

– SENJ – ZAGREB (jedna linija odnosno polazak i povratak)

– KORČULA – ZAGREB (jedna linija odnosno polazak i povratak)

Linija odnosno polazak i povratak utvrditi će se temeljem trenutnih potreba putnika.

3. Županijske linije za otok Krk 3; Cres, Lošinj, Rab 2, Pag 1, te Korčula 1 linija, odnosno polazak, a povratak za svaki otok ovisno o trenutnim potrebama putnika.

4. Ugovoreni poslovi s Županijama i Gradovima za prijevoz učenika osnovnog i srednjeg obrazovanja.

5. Radionice

– PJ SERVIS 1 automehaničar i 1 autoelektričar po smjeni
...
Štrajk se mora najaviti u pismenom obliku sa naznakom razloga za štrajk, mjesta, dana i vremena početka štrajka.
...
Za Poslodavca su to Mira Mikuličić i Višnja Dedić, za Pregovarački odbor sindikata su to Duško Kulaš i Sanja Matešić.
...
Ovaj ugovor stupa na snagu i primjenjuje se od 1. siječnja 2010. godine, a bit će objavljen u skladu s člankom 265. Zakona o radu (»Narodne novine« br. 149/09)

### Članak 87.

Ovaj ugovor zaključuje se na vrijeme od jedne godine i važi do 31. prosinca 2010. godine, osim za članke 30. i 33. za koje će ugovor važiti do 30. lipnja 2010. godine, te za iste pregovori moraju započeti najkasnije do 15. travnja 2010. godine.

Nakon isteka roka iz prethodnog stavka ovog članka, a sukladno članku 262. Zakona o radu (»Narodne novine« br. 149/09) odredbe ovog Kolektivno ugovora se ne primjenjuju.
...
Nakon sklapanja ovog kolektivnog ugovora Poslodavac će donijeti novi Pravilnik o radu, s tim da će se plaće obračunavati u skladu s ovim kolektivnim ugovorom od 1. siječnja 2010. godine.

### Članak 92.

Svaka ugovorna strana snosi svoje troškove u svezi ovog ugovora.

( *** zaključeno s člankom 92 *** )

Sindikat radnika Autotrans Autotrans d.o.o. Rijeka

predsjednik predsjednik Uprave

Romano Pužar, v. r. Zvonko Krmpotić dipl. oec., v. r.

TARIFNI RAZREDI

| GRUPA | SLOŽENOST | KOEFICIJENT |
| --- | --- | --- |
| I | Jednostavni rutinski rad | 1,00 – 1,25 |
| II | Manje zahtjevan rad | 1,26 – 1,58 |
| III | Poslovi manje složenosti | 1,59 – 1,99 |
| IV | Poslovi srednje složenosti | 2,00 – 2,60 |
| V | Složeniji poslovi i zadaci | 2,61 – 3,39 |
| VI | Samostalan srednje stručni operativni rad | 3,40 – 4,42 |
| VII | Samostalan stručni rad | 4,43 – 5,76 |
| VIII | Samostalan stručni rad višeg stupnja | 5,77 – 7,98 |
| IX | Visoko stručni rad koji zahtijeva kreativnost i inicijativu | 7,99 i više |
