...
identifier: "HR-NN-2019-38-785"
country: "hr"
rank: "pravilnik"
publication_date: "2019-04-12"
last_updated: "2019-04-12"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2019/38/785"
act_number: "785"
...
n) »Ribolovna aktivnost« – potraga za ribom, bacanje, polaganje, povlačenje i potezanje ribolovne opreme, izvlačenje ulova na palubu, prekrcaj, zadržavanje na palubi, prerada na brodu, prebačaj, stavljanje u kaveze, tov i iskrcaj ribe i proizvoda ribarstva;

o) »Ribolovni dan« – svaki kalendarski dan kada se obavlja ribolovna aktivnost, a koji je evidentiran sukladno Zakonu o morskom ribarstvu te u skladu sa propisima iz područja dostave očevidnika i/ili izvješća o ulovu u gospodarskom ribolovu;

p) »Segment flote« – skupina plovila iste dužinske kategorije (duljina preko svega) s istim dominantnim ribolovnim alatom tijekom godine na koju se odnosi izvješće o ribolovnom kapacitetu iz članka 3. stavka 2. ovoga Pravilnika;
...
d) ribarsko plovilo mora imati ostvarenu ribolovnu aktivnost od najmanje 20 ribolovnih dana u godini koja prethodi podnošenju Zahtjeva za potporu;
...
i) operacija ne smije biti fizički završena ili provedena u cijelosti, tj. motor ne smije biti ugrađen u ribarsko plovilo i stavljen u funkciju u trenutku podnošenja Zahtjeva za potporu;

j) ulaganje koje je predmet potpore ne smije biti financirano nikakvim drugim javnim izdacima;

k) korisnik mora osigurati nepostojanje sukoba interesa s izvođačima radova i/ili ponuditeljima/dobavljačima roba i/ili usluga koji su predmet ulaganja odnosno nepostojanje ostalih slučajeva sukoba interesa u postupcima nabave predmeta ulaganja u skladu sa Natječajem.
...
(2) Korisnik je dužan djelovati u skladu s uvjetima iz članka 4. stavka 2. točaka a), b) i c) ovoga Pravilnika tijekom cijelog razdoblja provedbe operacije i tijekom pet godina nakon konačne uplate sredstava korisniku.
...
(5) Iznimno od stavka 4. ovoga članka, korisnik uslijed nepredviđenih okolnosti ili više sile može obaviti navedene radnje uz prethodno pribavljeno odobrenje Upravljačkog tijela ne dovodeći u pitanje odredbe članka 71. Uredbe (EU) br. 1303/2013.
...
(13) Korisnik je dužan osigurati funkcionalnost i namjenu ulaganja (opreme, uređaja, objekata i ostalih stavki u sklopu operacije) prilikom redovne kontrole iz članka 2. stavka 1. točke m), ne dovodeći u pitanje stavke 3. i 4. ovoga članka.
...
(2) Motor iz stavka 1. ovoga članka mora biti službeno certificiran u skladu sa člankom 40. stavkom 2. Uredbe (EZ) br. 1224/2009.
...
q) nabava patenata, licenci, posebnih znanja i vještina ili nepatentiranog tehničkog znanja;

r) novčane kazne, financijske kazne te troškovi parničnog i upravnog postupka;

s) troškovi nastali prije datuma propisanog u članku 7. stavku 2. ovoga Pravilnika, kao i troškovi nastali poslije navedenog datuma ako se radi o troškovima koji ne mogu biti potvrđeni kontrolom na terenu iz članka 20. ovoga Pravilnika.
...
(4) Sredstva javne potpore iz stavka 3. ovoga članka iznose ukupno 2.000.000,00 eura u protuvrijednosti u kunama, od čega:
...
(8) Potpora se isplaćuje tek nakon što je potrebno smanjenje kapaciteta u kW trajno uklonjeno iz registra ribarske flote Europske unije.
...
(1) U trenutku podnošenja Zahtjeva za isplatu zamjena motora mora biti fizički završena te moraju biti ispunjeni uvjeti iz članka 5. stavka 1. te članka 6. stavka 2. odnosno stavka 3. ovoga Pravilnika.
...
(6) Prigovori se podnose preporučenom pošiljkom s povratnicom, u roku od petnaest dana od dana preuzimanja akata iz stavka 4. ovoga članka ili proteka osmog dana od dana objave na oglasnoj ploči, na adresu: Ministarstvo poljoprivrede, Uprava ribarstva, Ulica grada Vukovara 78, 10000 Zagreb, uz naznaku: »Povjerenstvo za odlučivanje o prigovorima – mjera I.21. Energetska učinkovitost i ublažavanje klimatskih promjena – zamjena motora«.
...
| --- | --- |
| POJAŠNJENJE: Bodovi na temelju ovoga kriterija se dodjeljuju ako plovilo koje je predmet potpore pripada segmentu malog priobalnog ribolova, tj. čija ukupna duljina ne prelazi 12 metara i koje u povlastici izdanoj za to plovilo nema upisane povlačne ribolovne alate iz popisa u tablici 3. Priloga I. Uredbi Komisije (EZ) br. 26/2004 od 30. prosinca 2003. o registru ribarske flote Unije te njene izmjene, tj. Provedbene uredbe Komisije (EU) br. 741/2014. Korisnik na temelju ovoga kriterija može ostvariti 12 bodova. |  |
| 1.1. Mali priobalni ribolov | 12 |

| 2. Starost postojećeg motora (najviše 6 boda) | Broj bodova |
| --- | --- |
| POJAŠNJENJE: Bodovi na temelju ovoga kriterija se dodjeljuju na temelju starosti postojećeg motora, tj. motora koji se zamjenjuje. Starost motora je cijeli broj koji se računa kao razlika u godinama između godine u kojoj se podnosi Zahtjev za potporu te godine gradnje/proizvodnje motora. Korisnik na temelju ovoga kriterija može ostvariti šest bodova ako udovoljava podkriteriju 2.1., četiri boda ako udovoljava podkriteriju 2.2. ili dva boda ako udovoljava podkriteriju 2.3. Najveći mogući broj bodova koji se može ostvariti na temelju ovoga kriterija je šest bodova. |  |
| 2.1. > 30 godina | 6 |
| 2.2. ≥ 15 ≤ 30 godina | 4 |
| 2.3. < 15 godina | 2 |

| 3. Snaga novog motora (najviše 4 boda) | Broj bodova |
| --- | --- |
| POJAŠNJENJE: Bodovi na temelju ovoga kriterija se dodjeljuju ovisno o smanjenju snage novog motora u odnosu na snagu postojećeg motora koji se zamjenjuje, po kategoriji plovila prema duljini plovila preko svega. Korisnik na temelju ovoga kriterija može ostvariti četiri boda ako udovoljava podkriteriju 3.1. ili dva boda ako udovoljava podkriteriju 3.2. Najveći mogući broj bodova koji se može ostvariti na temelju ovoga kriterija je četiri boda. |  |
| Za plovila duljine preko svega < 12 metara |  |
| 3.1. Snaga novog motora u kW manja od snage dosadašnjeg | 4 |
| 3.2. Snaga novog motora u kW jednaka snazi dosadašnjeg | 2 |
| Za plovila duljine preko svega ≥ 12 < 18 metara |  |
| 3.1. Snaga novog motora u kW manja za >25% od snage dosadašnjeg | 4 |
| 3.2. Snaga novog motora u kW manja za ≥ 20 ≤ 25% od snage dosadašnjeg | 2 |
| Za plovila duljine preko svega ≥ 18 < 24 metara |  |
| 3.1. Snaga novog motora u kW manja za > 35% od snage dosadašnjeg | 4 |
| 3.2. Snaga novog motora u kW manja za ≥ 30 ≤ 35% od snage dosadašnjeg | 2 |
