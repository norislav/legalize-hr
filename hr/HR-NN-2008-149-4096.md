---
title: "Zakon o izvršavanju Državnog proračuna Republike Hrvatske za 2009. godinu"
identifier: "HR-NN-2008-149-4096"
country: "hr"
rank: "zakon"
publication_date: "2008-12-20"
last_updated: "2008-12-20"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2008/149/4096"
...
O PROGLAŠENJU ZAKONA O IZVRŠAVANJU DRŽAVNOG PRORAČUNA REPUBLIKE HRVATSKE ZA 2009. GODINU

Proglašavam Zakon o izvršavanju Državnog proračuna Republike Hrvatske za 2009. godinu, koji je Hrvatski sabor donio na sjednici 15. prosinca 2008. godine.

Klasa: 011-01/08-01/175
...
O IZVRŠAVANJU DRŽAVNOG PRORAČUNA REPUBLIKE HRVATSKE ZA 2009. GODINU

I. OPĆE ODREDBE

### Članak 1.

Ovim se Zakonom uređuju prihodi, primici, rashodi i izdaci Državnog proračuna Republike Hrvatske za 2009. godinu (dalje u tekstu: Proračun) i njegovo izvršavanje, opseg zaduživanja i jamstava države, upravljanje javnim dugom te financijskom i nefinancijskom imovinom, poticajne mjere u gospodarstvu, korištenje namjenskih prihoda i primitaka, korištenje vlastitih prihoda, prava i obveze korisnika proračunskih sredstava, pojedine ovlasti Vlade Republike Hrvatske (dalje u tekstu: Vlada), predsjednika Vlade, Ministarstva financija (dalje u tekstu: Ministarstvo) i ministra financija u izvršavanju Proračuna, kazne za neispunjavanje obveza te druga pitanja u izvršavanju Proračuna.
...
Sredstva se u Proračunu osiguravaju proračunskim korisnicima (dalje u tekstu: korisnici), koji su u njegovu Posebnom dijelu određeni za nositelje sredstava raspoređenih po programima (aktivnostima i projektima) i po vrstama rashoda i izdataka.
...
(3) Tijekom mjeseca može se iznimno izvršiti dodatna dodjela na temelju posebnog zahtjeva kojega odobrava glavni državni rizničar ili osoba koju on odredi.
...
(1) Korisnici – nositelji projekata su obvezni u financijskom planu planirati sredstva učešća Republike Hrvatske za projekte financirane iz pomoći i/ili namjenskih primitaka u iznosu koji je predviđen u ugovoru za financiranje projekta, razmjerno sredstvima koja će se koristiti u 2009. godini.

(2) Sredstva učešća iz stavka 1. ovoga članka ne mogu se preraspodijeliti na aktivnosti i projekte koji se financiraju iz općih prihoda i primitaka.
...
Aktivnosti i projekti koji se financiraju iz predpristupnih programa pomoći Europske unije, te kapitalni projekti u slučaju kada nisu izvršeni do kraja tekuće godine mogu se prenijeti i izvršavati u sljedećoj godini ako su ispunjeni osnovni preduvjeti:
...
(1) Korisnici su dužni sredstva doznačena iz Proračuna do 31. prosinca 2009. godine uključujući i vlastite prihode, a za koja nisu iskazane obveze u Bilanci na dan 31. prosinca 2009. godine vratiti u Proračun.
...
(1) U Proračunu su planirana sredstva proračunske zalihe u iznosu od 429.977.617,00 kuna.
...
(1) U skladu s odredbama Zakona o ustrojstvu i djelokrugu središnjih tijela državne uprave (»Narodne novine«, br. 199/03., 30/04., 136/04., 22/05., 44/06., 5/08. i 27/08.), a u vezi sa člankom 58. Zakona o proračunu (»Narodne novine«, br. 87/08.) raspoređuju se sredstva na korisnike ili u proračunsku zalihu, a odluke o raspoređivanju objavljuju se u »Narodnim novinama«.
...
(1) Radi pravodobnog obračunavanja i doznačavanja proračunskih sredstava u 2009. godini za plaće i druge rashode, korisnici koji se financiraju iz Proračuna obvezni su nadležnom ministarstvu dostaviti rješenje o zasnivanju i o prestanku radnog odnosa radnika.
...
(4) Odluke o davanju suglasnosti za zaduživanje jedinicama lokalne i područne (regionalne) samouprave koje je Vlada donijela do 31. prosinca 2008. godine a koje se mogu koristiti od 1. siječnja 2009. godine ulaze u ograničenje od 2,3 posto iz stavka 2. ovoga članka.

### Članak 19.

(1) Doprinosi za mirovinsko i obvezno zdravstveno osiguranje koji su uplaćeni za osiguranike prema članku 23. Zakona o obnovi i razvoju Grada Vukovara (»Narodne novine«, br. 44/01., 90/05. i 80/08.), vratit će se poslodavcima sa sjedištem, odnosno s prebivalištem na području Grada Vukovara, Iloka te Lovasa i Tovarnika na teret tih doprinosa.
...
(3) Sredstva za nadoknadu štete na neosiguranoj imovini (poslovne zgrade, uređaji, instalacije, oprema i dr.) osigurana su u Proračunu i doznačavat će se korisnicima na njihov zahtjev.
...
(1) Korisnik koji je stekao nekretninu obavezan je u roku od 30 dana od dana njezina stjecanja podnijeti zahtjev Državnom odvjetništvu Republike Hrvatske (dalje u tekstu: Državno odvjetništvo) da podnese prijedlog za upis prava vlasništva Republike Hrvatske i drugih stvarnih prava na nekretninama kojih je nositelj Republika Hrvatska u zemljišne knjige, s potrebnom dokumentacijom.
...
Državno odvjetništvo podnosi zemljišnoknjižni prijedlog za upis nekretnine iz članka 69. stavak 2. Zakona o proračunu («Narodne novine«, br. 87/08.) ako je Vlada dala prethodnu suglasnost u skladu sa člankom 69. stavak 2. Zakona o proračunu.
...
(1) Ovlašćuje se Vlada da se može zadužiti na inozemnom i domaćem tržištu novca i kapitala do ukupnog iznosa od 12.764.034.950,00 kuna, koji je iskazan u računu financiranja Proračuna.

(2) Tekuće otplate glavnice državnoga duga, iskazane u Računu financiranja Proračuna za 2009. godinu u iznosu od 9.825.117.452,00 kuna, te pripadajuće kamate imaju u izvršavanju Proračuna prednost pred svim ostalim izdacima.

(3) Ukupna visina zaduženja iskazana u financijskim planovima izvanproračunskih korisnika državnog proračuna iznosi 1.474.206.840,00 kuna. Tekuće otplate glavnice duga, iskazane u financijskim planovima izvanproračunskih korisnika državnog proračuna iznose 487.913.680,00 kuna.
...
U 2009. godini ukupan državni dug može iznositi najviše 48 posto od ukupnog bruto domaćeg proizvoda u 2009. godini.
...
(2) Godišnja vrijednost novih financijskih jamstava za 2009. godinu iznosi 4.900.000.000,00 kuna.

(3) Jamstvena zaliha za financijska državna jamstva u Proračunu iznosi 267.000.000,00 kuna.

(4) Tražitelj jamstva je dužan dokumentirani zahtjev dostaviti nadležnom ministarstvu. Nadležno ministarstvo će zaprimljeni dokumentirani zahtjev dostaviti u roku od trideset dana od zaprimanja Agenciji za zaštitu tržišnog natjecanja (dalje u tekstu: Agencija) na odobrenje.
...
(11) Vlada može iznimno odobriti jamstvo za zaduženje određenog korisnika vezano uz provedbu prioritetnog programa/projekta koji ima značenje za regionalnu gospodarsku stabilnost, uz ublažavanje gospodarske nerazvijenosti određenog područja, uklanjanje ratnih šteta, obnovu ili hitnu obnovu od posljedica elementarnih nepogoda.
...
Za temeljni kapital, subvenciju kamata i udio u kreditima Hrvatske banke za obnovu i razvitak u 2009. godini osigurava se 490.000.000,00 kuna.
...
(1) Plaćeni porez na dodanu vrijednost po računima za nabavu opreme u 2009. godini za obavljanje vatrogasne djelatnosti, vratit će se na teret prihoda poreza na dodanu vrijednost, javnim vatrogasnim postrojbama, dobrovoljnim vatrogasnim društvima i vatrogasnim zajednicama.
...
(6) Županijsko poglavarstvo dužno je do 30. ožujka 2009. donijeti raspored sredstava na općine i gradove iz stavka 4. ovoga članka te ga u roku od 15 dana nakon donošenja dostaviti Ministarstvu.

(7) Kriteriji za izračun i raspodjelu pomoći općinama i gradovima iz stavka 1. ovoga članka jesu: broj stanovnika prema popisu iz 2001. godine, prosjek prihoda po stanovniku za 2007. godinu općina i gradova na razini države (državni prosjek), prosjek prihoda po stanovniku skupine (članak 4. i 5. Zakona o područjima posebne državne skrbi »Narodne novine«, br, 86/08.), odnosno pojedine općine i grada, broj stanovnika po 1 km na razini I. i II. skupine područja posebne državne skrbi (skupinski prosjek) i broj stanovnika po
1 km pojedine općine i grada, udio rashoda za kapitalne programe za 2007. godinu u ukupnim rashodima, racionalnost izvršenja funkcija sustava (broj zaposlenih, rashod po zaposlenom) i rashodi za funkcije grada (ispod 30.000 stanovnika) u 2007. godini.
...
(10) Na korisnike pomoći iz stavka 1. ovoga članka primjenjuju se i odredbe o rashodima za zaposlene i o ostalim rashodima i naknadi troškova zaposlenima koje se odnose na korisnike Proračuna, a u skladu s člankom 128. Zakona o službenicima i namještenicima u lokalnoj i područnoj (regionalnoj) samoupravi (»Narodne novine«, br. 86/08.).
...
(15) Županijama, općinama i gradovima koji kupuju dionice ili udjele u trgovačkom društvu suprotno članku 64. Zakona o proračunu (»Narodne novine«, br. 87/08.) Ministarstvo će obustaviti doznaku pomoći.
...
(1) Obveze uplate namjenskih prihoda i primitaka ne odnose se na: znanost, visoko obrazovanje, zdravstvene ustanove, pravosuđe, sustav izvršenja sankcija i ustanove kulture.

(2) Obveze uplate donacija ne odnose se na ustanove socijalne skrbi.
...
(1) Obveze uplate vlastitih prihoda ne odnose se na: znanost, visoko obrazovanje, zdravstvene ustanove, ustanove socijalne skrbi, sustav izvršenja sankcija i ustanove kulture.
...
VII. ODGODA PRIMJENE ODREĐENIH ODREDABA ZAKONA O PRORAČUNU

### Članak 43.

(1) Kod planiranja Proračuna nisu se primijenili članci 26., 28. i 29. Zakona o proračunu (»Narodne novine«, br. 96/03.).

(2) Odredbe stavka 1. ovoga članka mogu se primijeniti i kod planiranja proračuna jedinica lokalne i područne (regionalne) samouprave za 2009. godinu.

VIII. ODGODA NAPLATE POREZA I DOPRINOSA
...
(2) Rok plaćanja može se odgoditi za jedan mjesec, a plaćanje u jednakim mjesečnim obrocima može se odobriti do deset mjeseci.
...
(5) Vlada će uz polugodišnji i godišnji izvještaj o izvršenju Proračuna izvijestiti Hrvatski sabor o radnjama iz ovoga članka.

IX. ODGODA I OBROČNA OTPLATA DUGA TE PRODAJA, OTPIS I DJELOMIČAN OTPIS POTRAŽIVANJA

### Članak 45.

(1) Ministar financija može u skladu s člankom 68. Zakona o proračunu (»Narodne novine«, br. 87/08.) i u skladu s Uredbom Vlade Republike Hrvatske donesene na temelju istoga članka, odgoditi plaćanje ili odobriti obročnu otplatu duga do pojedinačnog iznosa duga od 1.000.000,00 kuna.

(2) Ministar financija može u skladu s člankom 68. Zakona o proračunu (»Narodne novine«, br. 87/08.) i u skladu s Uredbom Vlade Republike Hrvatske donesene na temelju istoga članka, prodati, otpisati ili djelomično otpisati potraživanje do pojedinačnog iznosa potraživanja od 50.000,00 kuna.

### Članak 46.

U skladu s člankom 68. Zakona o proračunu (»Narodne novine«, br. 87/08.) i u skladu s Uredbom Vlade Republike Hrvatske donesene na temelju istoga članka, plaćanje duga može se odgoditi za jedan mjesec, a plaćanje u jednakim mjesečnim obrocima može se odobriti do deset mjeseci.
...
5. ako neophodne rashode isplaćuje iznad razine utvrđene člankom 31. stavak 18. ovoga Zakona,

6. ako isplaćuje plaće i ostala materijalna prava suprotno članku 38. stavak 10. ovoga Zakona,

7. ako vlastite prihode koristi suprotno članku 42. ovoga Zakona.

### Članak 48.

(1) Uz novčanu kaznu iz članka 47. ovoga Zakona izreći će se i zaštitna mjera obustave daljnjih mjesečnih dodjela u slučajevima korištenja sredstava Proračuna protivno zakonu.
