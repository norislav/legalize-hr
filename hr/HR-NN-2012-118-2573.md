...
identifier: "HR-NN-2012-118-2573"
country: "hr"
rank: "pravilnik"
publication_date: "2012-10-26"
last_updated: "2012-10-26"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2012/118/2573"
...
Ovim Pravilnikom uređuje se postupak raspisivanja Javnih poziva, uvjeti podnošenja natječajne prijave, kriteriji za dodjelu sredstava, Program potpora sukladno posebnim propisima o državnim potporama, rad umjetničkih savjetnika i Umjetničkog vijeća te nadzor nad namjenskom potrošnjom sredstava.
...
Sredstva koja se dodjeljuju putem Javnog poziva za poticanje audiovizualnih djelatnosti i stvaralaštva u kategoriji poticanja proizvodnje audiovizualnih djela iz ovog Pravilnika, predstavljaju državne potpore sukladno važećim propisima o državnoj potpori kinematografskoj i ostaloj audiovizualnoj djelatnosti.

Osim sredstava iz stavka 1. ovog članka, temeljem ovog Pravilnika, a putem javnih poziva, dodjeljuju se još i sredstva za:
...
koja predstavljaju potpore male vrijednosti (de minimis) sukladno važećim propisima o državnoj potpori kinematografskoj i ostaloj audiovizualnoj djelatnosti.

Izvori financijskih sredstava Hrvatskog audiovizualnog centra (u daljnjem tekstu HAVC) za dodjelu državnih potpora su Državni proračun Republike Hrvatske, s pozicije nadležnog ministarstva, i sredstva osigurana odredbama Zakona o audiovizualnim djelatnostima.

Za kvalificirano pristupanje Javnom pozivu za dobivanje državnih potpora iz stavka 1. ovog članka, potrebno je ostvariti minimalan broj bodova u Kvalifikacijskom testu koji je Dodatak ovom Pravilniku i čini njegov sastavni dio.

Vremensko trajanje državnih potpora iz ovog Pravilnika određeno je vremenskim važenjem Nacionalnog programa promicanja audiovizualnog stvaralaštva.
...
AV Vijeće na temelju prijedloga ravnatelja HAVC-a (u daljnjem tekstu: ravnatelj) raspisuje Javni poziv za poticanje audiovizualnog stvaralaštva sukladno Nacionalnom programu promicanja audiovizualnih djelatnosti (u daljnjem tekstu: Nacionalni program), koji je otvoren tijekom cijele godine. Objavljuje se na internetskoj stranici HAVC-a i u »Narodnim novinama«.
...
Cilj ove kategorije unutar Javnog poziva iz članka 3. jest kontinuitet, rast i razvoj audiovizualne proizvodnje u Republici Hrvatskoj.
...
• snimljeni filmovi u svim navedenim grupama.
...
– redatelji/ice i producenti/ice koji su u dosadašnjem radu prekršili/e ugovorne obveze prema HAVC-u, i/ili drugim sudionicima u realizaciji projekta sufinanciranog od HAVC-a, a koje obveze nisu ispunjene do trenutka podnošenja prijave
...
7. dokaz o bonitetu producenta/ice (BON-1 i BON-2),

8. izvadak iz nadležnog registra,

9. potvrdu nadležne porezne uprave o podmirenju dospjelih obveza po osnovi javnih davanja,
...
Prijavnica koja se predaje treba biti supotpisana od strane nositelja projekta – producenta/ice i redatelja/ice, čime se smatra da producent/ica i redatelj/ica ovjeravaju sav natječajni materijal.
...
Prijave s cjelovitom dokumentacijom bit će uzete u postupak vrednovanja uvažavajući datum podnošenja iste te utvrđene rokove odlučivanja, koji su javno dostupni na internetskim stranicama HAVC-a.
...
Projekti koji su ostvarili minimalan broja bodova u Kvalifikacijskom testu koji je Dodatak ovom Pravilniku, vrednuju se prema sljedećim kriterijima, ovim redoslijedom važnosti:
...
Pojmovi audiovizualno djelo niskoga proračuna i teško ili zahtjevno audiovizualno djelo određeni su Zakonom o audiovizualnim djelatnostima.
...
Sva ostala audiovizualna djela koja u smislu ovog Pravilnika i Zakona o audiovizualnim djelatnostima nisu niskoproračunska, niti teška ili zahtjevna djela, smatraju se standardnim djelima.
...
Stručna služba HAVC-a priprema ugovore, utvrđuje ispunjavanje ugovornih obveza u svakoj fazi sufinanciranja te obavlja i druge poslove vezane uz realizaciju ugovora i financiranje, a uz dogovor s nositeljima projekta obavlja i poslove promidžbe i plasmana hrvatskog filma.
...
Promjene u dinamici isplate sredstava za pojedinu fazu proizvodnje odobrava ravnatelj, a sukladno ovom Pravilniku i odredbama ugovora sklopljenim s HAVC-om.
...
HAVC putem svoje stručne službe, vanjske revizije ili na druge zakonom određene načine prati i nadzire pravilno i zakonito trošenje sredstava sukladno odredbama ovoga Pravilnika do visine iznosa koji je HAVC dodijelio.
...
Kandidati u podkategoriji razvoja projekta obavezno prilažu prijavnicu (koja se nalazi na internetskoj stranici HAVC-a) za svaki projekt.
...
– dokaz o bonitetu producenta/ice (BON-1 i BON-2).
...
Kategoriju poticanja razvoja scenarija i razvoja projekata televizijskih djela unutar Javnog poziva iz članka 3. HAVC raspisuje prema financijskim mogućnostima, a najmanje jedanput godišnje. U navedenoj kategoriji rok za predaju prijave je 30 dana, a rezultati se objavljuju po isteku narednih 80 dana.
...
Pravo sudjelovanja u ovoj podkategoriji imaju, neovisni producenti s tvrtkama registriranim za proizvodnju audiovizualnih djela upisane u odgovarajući registar u Republici Hrvatskoj: scenarist/ica ili autor/ica literarnog predloška, redatelj/ica koji/a piše scenarij ili samostalna producent/ica koji/a želi razviti scenarij ili bilo koja kombinacija ovih navedenih fizičkih ili pravnih osoba.
...
Umjetnički savjetnik čije je rad u prvom mandatu AV Vijeće ocijenilo uspješnim, može biti ponovno imenovan za još jedno uzastopno mandatno razdoblje.
...
Pravo sudjelovanja na Javnom pozivu za komplementarne djelatnosti imaju fizičke i pravne osobe koje se bave komplementarnim djelatnostima i upisane su u odgovarajući registar u Republici Hrvatskoj.
...
Uz prijavnicu obvezatno treba priložiti priloge navedene u Javnom pozivu za komplementarne djelatnosti i dostaviti HAVC-u u naznačenom roku i u navedenom broju primjeraka.
...
Ako nositelj tijekom izvršenja projekta namjerava promijeniti financijski plan za više od 20%, dužan je prethodno pribaviti suglasnost AV Vijeća.
...
Pravo sudjelovanja na Javnom pozivu za programe međunarodne suradnje imaju fizičke osobe i pravne osobe koje su registrirane i bave se komplementarnim djelatnostima sa sjedištem u Republici Hrvatskoj.
...
Uz prijavnicu obavezno treba priložiti priloge navedene u Javnom pozivu i dostaviti HAVC-u u naznačenom roku i u navedenom broju primjeraka.
...
Stupanjem na snagu ovoga Pravilnika prestaje važiti Pravilnik o postupku, kriterijima i rokovima za provedbu Nacionalnog programa promicanja audiovizualnog stvaralaštva (»Narodne novine« broj 115/10).
...
Osnovni uvjeti: da bi projekt zadovoljio kvalifikacijski test, mora ostvariti minimalno 15 bodova od ukupno 28 mogućih.
...
* Ispunjavaju umjetnički savjetnici
...
| --- | --- | --- | --- | --- |
|  |  |  |  |  |
| B1 | Djelo će pridonijeti razvoju svog žanra | 3 |  |  |
| B2 | Djelu će doprinos dati državljani Republike Hrvatske u ulozi: |  |  |  |
|  | a) | Redatelja | 1 |  |
|  | b) | Producenta | 1 |  |
...
| --- | --- | --- | --- |
|  | Najmanje 50% djelatnika predviđenih za angažman u proizvodnji djela državljani su Republike Hrvatske. | 6 |  |
|  | ili |  |  |
|  | Najmanje 40% djelatnika predviđenih za angažman u proizvodnji djela državljani su Republike Hrvatske. | 4 |  |
|  | ili |  |  |
|  | Najmanje 30% djelatnika predviđenih za angažman u proizvodnji djela državljani su Republike Hrvatske. | 3 |  |
|  | UKUPNO | 6 |  |
| SVEUKUPNO B) | 15 |  |  |
