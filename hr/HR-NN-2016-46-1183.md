...
identifier: "HR-NN-2016-46-1183"
country: "hr"
rank: "pravilnik"
publication_date: "2016-05-18"
last_updated: "2016-05-18"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2016/46/1183"
act_number: "1183"
...
(1) Ministarstvo poljoprivrede (u daljnjem tekstu: Ministarstvo) na temelju podnesenog zahtjeva za izdavanje povlastice za obavljanje gospodarskog ribolova na moru (u daljnjem tekstu Zahtjev) od strane vlasnika plovila, donosi rješenje o izdavanju povlastice i izdaje povlasticu.
...
– darovanja plovila s povlasticom bračnom drugu, djeci, roditeljima ili unucima,
...
(3) Uz rješenje o izdavanju povlastice izdaje se i povlastica koja se uvijek mora nalaziti na plovilu.

(4) Na jedno plovilo se može izdati samo jedna povlastica.

### Članak 3.

(1) Vlasnik plovila podnosi zahtjev za izdavanjem povlastice mjesno nadležnoj Ispostavi Ministarstva nadležnoj za obavljanje poslova ribarstva (u daljnjem tekstu: Ispostava) u kojoj pravna osoba ima sjedište odnosno fizička osoba prebivalište.
...
(3) Ukoliko nastane bilo koja promjena podataka, koji su sastavni dijelovi povlastice, vlasnik plovila dužan je u roku od 15 dana od dana nastanka promjene podnijeti novi zahtjev, te će Ministarstvo donijeti novo rješenje sukladno zakonskim propisima i izdati novu povlasticu.
...
12. odluka Upravnog suda, broj i datum iste,
...
(2) Prijenos povlastice u cijelosti u slučajevima iz stavka 1. točke 1. ovoga članka izvršit će se ukidanjem povlastice starog vlasnika plovila i izdavanjem povlastice na novog vlasnika istog plovila s pravima na iste ribolovne alate i ribolovne zone iz ukinute povlastice.

(3) Prijenos povlastice u cijelosti u slučaju iz stavka 1. točke 2. ovoga članka izvršit će se ukidanjem povlastice starog vlasnika plovila i izdavanjem povlastice na novog vlasnika drugog plovila s pravima na iste ribolovne alate i ribolovne zone iz ukinute povlastice.

(4) Prijenos povlastice sukladno stavku 3. ovoga članka može se izvršiti isključivo ako je drugo plovilo iste ili manje veličine u GT i iste ili manje snage porivnog stroja u kW.
...
(2) Zamjena plovila sukladno stavku 1. ovoga članka izvršit će se ukidanjem povlastice vlasnika plovila u koju je upisano staro plovilo i izdavanjem povlastice istom vlasniku u koju će se upisati novo plovilo s pravima na iste ribolovne alate i ribolovne zone iz ukinute povlastice.

(3) Iznimno od stavka 1. ovoga članka dozvoljava se upis plovila veće veličine u GT i veće snage porivnog stroja u kW u slučaju kada isti vlasnik posjeduje dva ili više plovila koja su upisana u važeće povlastice te ih želi zamijeniti jednim novim plovilom.

(4) Zamjena plovila sukladno stavku 3. ovoga članka izvršit će se ukidanjem dvije ili više povlastica vlasnika plovila u koje su upisana stara plovila i izdavanjem jedne nove povlastice istom vlasniku u koju će se upisati novo plovilo s pravima na iste ribolovne alate i ribolovne zone iz ukinutih povlastica.

(5) Zamjena plovila sukladno stavcima 3. i 4. ovoga članka dozvoljava se isključivo ako je novo plovilo iste ili manje veličine u GT od zbroja GT-a zamijenjenih plovila i ako je snaga porivnog stroja novog plovila ista ili manja od zbroja snaga porivnih strojeva sa zamijenjenih plovila.
...
(7) Upis promjene veličine plovila u GT u povlasticu odobrit će se isključivo ako se radi o smanjenju GT-a osim u slučaju kad je do promjene GT-a na postojećem plovilu upisanom u povlasticu došlo na temelju novog izračuna GT-a izvršenom od strane nadležnog tijela, a bez ikakvog zahvata na plovilu što se dokazuje odgovarajućom potvrdom od nadležnog tijela.

(8) Iznimno od odredbi stavka 7. ovoga članka odobrit će se upis promjene veličine plovila u GT, odnosno povećanje GT, ukoliko vlasniku plovila bude odobren prethodno podnesen zahtjev za povećanjem tonaže plovila.

(9) Zahtjev za povećanjem tonaže plovila iz stavka 8. ovoga članka podnosi se Ministarstvu, a odobriti će se ako ispunjava sljedeće uvjete:

a) plovilu nije već prethodno odobreno povećanje tonaže temeljem stavka 8. ovoga članka,
...
(10) Zadovoljavanje uvjeta propisanih stavkom 9. ovoga članka dokazuje se potvrdom od strane nadležnog tijela.

(11) Iznimno od stavka 1. ovoga članka, za sva plovila iz Registra ribarske flote RH koja imaju veličinu u GT između 0,0 i 1,0 smatra se da im je veličina u GT jednaka 1.
...
(3) Zahtjev za preuzimanje pohranjene povlastice vlasnik plovila podnosi nadležnoj Ispostavi Ministarstva najkasnije 15 dana prije početka obavljanja gospodarskog ribolova ili isteka roka pohrane.
...
(5) Iznimno od stavka 3. ovoga članka vlasnik plovila nije dužan preuzeti pohranjenu povlasticu u slučaju kada obavijesti Ministarstvo o namjeri prodaje povlastice putem javnog poziva prije isteka roka pohrane.
...
(1) Vlasnik plovila na koje je izdana povlastica (u daljnjem tekstu: prodavatelj) može ponuditi na prodaju samo povlasticu, a o namjeri prijenosa same povlastice obvezan je izvijestiti Ministarstvo radi otkupa za prijenos povlastice u državno vlasništvo, odnosno prodaje povlastice putem Javnog poziva osobama zainteresiranima za otkup i prijenos prava iz povlastice (u daljnjem tekstu: ponuditelj).

(2) Prijenos povlastice iz stavka 1. ovoga članka putem Javnog poziva dozvoljen je samo ukoliko se odnosi na povlastice temeljem koje je obavljan ribolov najmanje 30 dana godišnje ili ukupno 150 dana u razdoblju od prethodnih pet kalendarskih godina prije podnošenja zahtjeva što je razvidno iz dostave podataka o ulovu. U izračun broja ribolovnih dana u prethodnih pet kalendarskih godina prije podnošenja zahtjeva ne ubraja se vrijeme tijekom kojeg je povlastica bila pohranjena.

(3) Javni poziv za prijenos povlastice objavljuje se u mjesecima ožujku, lipnju, rujnu i prosincu.

(4) Podnošenjem ponude u Javnom pozivu mogu sudjelovati, fizičke ili pravne osobe koje ispunjavaju uvjete iz članka 14. stavka 3. Zakona o morskom ribarstvu i koje su vlasnici plovila na koje se može izvršiti prijenos povlastice. Dozvoljava se isključivo prijenos povlastice na plovilo jednake ili manje bruto tonaže u GT i jednake ili manje snage porivnog stroja u kW. Nije dozvoljen prijenos povlastice s plovila ukupne duljine manje od 12 metara na plovilo ukupno duljine veće od 12 metara.

(5) U postupku prijenosa povlastice nakon Javnog poziva iz stavka 3. ovoga članka, Ministarstvo će kod prodaje u obzir uzeti najvišu ponuđenu cijenu.

(6) Ukoliko kod prodaje ima više od jedne najviše ponuđene cijene s identičnim iznosom rangiranje se obavlja temeljem sljedećih kriterija:
...
(7) Ministarstvo će, temeljem kriterija iz stavaka 5. i 6. ovoga članka, izvršiti odabir pristiglih važećih ponuda i donijeti Odluku o izboru osobe za prijenos povlastice i o tome obavijestiti prodavatelja i ponuditelja.

(8) Osobe iz stavka 7. ovoga članka će, nakon primitka obavijesti o provedbi Javnog poziva, sklopiti kupoprodajni ugovor o prijenosu povlastice. Nadležna Ispostava će, temeljem zahtjeva ponuditelja, donijeti rješenje o prestanku važenja povlastice prodavatelja i donijeti rješenje o izdavanju povlastice ponuditelju za novo plovilo.

(9) Ukoliko osoba koja je izabrana za prijenos povlastice kao najpovoljniji ponuditelj odustane od kupnje i prijenosa povlastice, to pravo prolazi na sljedećeg ponuditelja sukladno Odluci iz stavka 7. ovoga članka.

(10) Prodavatelj može odustati od prijenosa povlastice o čemu mora obavijestiti Ministarstvo u roku od osam dana od dana dobivanja obavijesti iz stavka 7. ovoga članka.

(11) Prodavatelj koji odustane od prijenosa povlastice nakon provedenog Javnog poziva ne smije ponovno zatražiti prijenos povlastice sljedeća tri mjeseca.
...
(5) Pod unutarnjim ribolovnim zonama iz stavka 4. ovoga članka podrazumijevaju se ribolovne zone E, F i G, a pod vanjskim ribolovnim zonama podrazumijevaju se ribolovne zone A, B, C i D.

(6) Zamjena ribolovnih zona iz stavka 4. ovoga članka za ribolovne alate za koje je propisano Odobrenje za gospodarski ribolov sukladno članku 23. Zakona o morskom ribarstvu može se odobriti isključivo ako plovilo posjeduje važeće Odobrenje za obavljanje gospodarskog ribolova predmetnim ribolovnim alatom.
...
| REPUBLIKA HRVATSKA MINISTARSTVO POLJOPRIVREDE  **POVLASTICA ZA GOSPODARSKI RIBOLOV NA MORU**  VLASNIK PLOVILA  Naziv/ime i prezime: _________________________________  Sjedište/prebivalište __________________________________  Adresa: ___________________________________________  OIB: _______________ MBO:__________________________  OVLAŠTENIK POVLASTICE  Naziv: ____________________________________________  Ime i prezime vlasnika ili odgovorne osobe: _________________  Sjedište: __________________________________________  Adresa: ___________________________________________  OIB: _______________ MBO:__________________________  PODACI O PLOVILU  Ime i luka upisa /Reg.oznaka plovila _______________________  CFR ______________________ Snaga (kW) _______________  Vanjska oznaka _______________ IRCS broj _______________  Tonaža (GT) _______________ Duljina (m) ________________  Serijski broj povlastice: _________ Država upisa ______________  Razdoblje obavljanja djelatnosti kod sezonskih obrta: __________ |
| --- |

– stražnja stranica obrasca povlastice

| Ribolovni alat:                                                 Ribolovna zona:  Pomoćna plovila:   Nadležna ispostava:________________  Klasa: __________________________  Urbroj: _________________________  Redni broj upisa u registar:_________  Mjesto, datum izdavanja  PO OVLAŠTENJU MINISTRA                                                 Potpis                                                 M.P. |
| --- |
