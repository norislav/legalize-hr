...
identifier: "HR-NN-2020-139-2698"
country: "hr"
rank: "otro"
publication_date: "2020-12-14"
last_updated: "2020-12-14"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2020/139/2698"
act_number: "2698"
...
Na temelju članka 12. i članka 15. stavka 1. Zakona o turističkim zajednicama i promicanju hrvatskog turizma (»Narodne novine«, broj 52/19, 42/20) Skupština Turističke zajednice ­Osječ­ko-ba­ranjske županije, uz prethodnu suglasnost Ministarstva turizma i sporta, na 5. sjednici održanoj 7. prosinca 2020. godine, donijela je
...
(1) Turistička zajednica Osječko-baranjske županije (u daljnjem tekstu: Zajednica) je organizacija koja djeluju po načelu destinacijskog menadžmenta, a osnovana je radi promicanja i razvoja turizma Republike Hrvatske i gospodarskih interesa pravnih i fizičkih osoba koje pružaju ugostiteljske usluge i usluge u turizmu ili obavljaju drugu djelatnost neposredno povezanu s turizmom na način da upravljaju destinacijom na razini Osječko-baranjske županije.

(2) Prava i obveze Zajednice utvrđene su Zakonom o turističkim zajednicama i promicanju hrvatskog turizma (u daljnjem tekstu: Zakon) i ovim Statutom.

### Članak 2.

(1) Za područje Osječko-baranjske županije osnovana je Turistička zajednica Osječko-baranjske županije.
...
(3) Turistička zajednica Osječko-baranjske županije je pravna osoba.

### Članak 3.

Turistička zajednica Osječko-baranjske županije upisana je u Upisnik turističkih zajednica koji vodi Ministarstvo turizma i sporta, pod upisnim brojem 122 na temelju rješenja, klasa: 334-03/11-02/7, urbroj: 529-05-12-6, od 30. studenoga 2012. godine.

### Članak 4.

(1) Naziv Zajednice je: »Turistička zajednica Osječko-baranjske županije«.

(2) Skraćeni naziv je »TZ OBŽ«.

(3) Sjedište Zajednice je u Osijeku.

### Članak 5.

(1) Zajednica ima pečat okruglog oblika, s nazivom i sjedištem »Turistička zajednica Osječko-baranjske županije Osijek« promjera 25 mm.

(2) Žig zajednice je četvrtastog oblika promjera 50 mm, a sadrži naziv i sjedište Zajednice, te prostor za upisivanje evidencijskog broja i datuma primitka pisama.
...
(2) Veći broj predstavnika pojedine turističke zajednice ovisi o turističkom značenju područja za koje je osnovana, a utvrđuje se razmjerno visini udjela turističke zajednice u prihodima Turističke zajednice Osječko-baranjske županije.
...
6. Obavljati druge poslove i zadaće u funkciji razvoja turizma i destinacije koji nisu u suprotnosti sa Zakonom i drugim propisima.
...
Obvezatni članovi Zajednice su turističke zajednice gradova, općina, mjesta i turističke zajednice područja osnovane na području Osječko-baranjske županije.

### Članak 14.

Obvezatno članstvo u Zajednici prestaje prestankom rada turističke zajednice grada, općine, mjesta i turističke zajednice područja osnovane na području Osječko-baranjske županije.
...
(2) Skupštinu Zajednice čine predstavnici turističkih zajednica gradova, općina, mjesta i turističkih zajednica područja osnovanih na području Osječko-baranjske županije.

### Članak 19.

(1) Broj predstavnika članova u skupštini Zajednice utvrđuje se tako da je svaka turistička zajednica zastupljena s najmanje jednim predstavnikom. Veći broj predstavnika pojedinačne turističke zajednice ovisi o turističkom značenju područja za koje je osnovana, a određuje se razmjerno udjelu turističke zajednice u prihodima Zajednice i to tako da:

– turistička zajednica općine, grada, područja ili mjesta s područja djelovanja Zajednice koja sudjeluje s manje od 2,00 % u ukupnom prihodu Zajednice ima jednog predstavnika u Skupštini Zajednice,

– turistička zajednica općine, grada, područja ili mjesta s područja djelovanja Zajednice koja sudjeluje s 2,01% do 5,00 % u ukupnom prihodu Zajednice ima dva predstavnika u Skupštini Zajednice,

– turistička zajednica općine, grada, područja ili mjesta s područja djelovanja Zajednice koja sudjeluje s 5,01 % do 10,00 % u ukupnom prihodu Zajednice ima tri predstavnika,

– turistička zajednica općine, grada, područja ili mjesta s područja djelovanja Zajednice koja sudjeluje s više od 10,01 u ukupnom prihodu Zajednice ima četiri predstavnika

(2) Udio u prihodu iz stavka 3. ovoga članka utvrđuje se prema prihodu u godini koja prethodi godini u kojoj se provode izbori za skupštinu Zajednice.

(3) Ako tijekom mandata dođe do promjene udjela u prihodima za više od 10 %, broj predstavnika članova Skupštine iznova će se utvrditi prema stavku 1. ovog članka.

(4) Promjenu iz stavka 3. ovog članka utvrđuje Skupština istodobno s donošenjem godišnjeg financijskog izvješća.
...
7. prihvaća godišnja izvješća i odlučuje o drugim pitanjima kada je to predviđeno propisima i ovim Statutom.

8. nadzire poslovanje Zajednice,

9. bira predstavnike Zajednice u Skupštinu Hrvatske turističke zajednice iz redova članova Zajednice,
...
12. odlučuje o drugim pitanjima kada je to predviđeno Zakonom, drugim propisima i ovim Statutom.
...
(2) Skupština Zajednice obvezna je obaviti nadzor najmanje jednom godišnje i to prije donošenja izvješća o izvršenju programa rada te je obvezna obaviti nadzor i na zahtjev natpolovične većine članova Skupštine, kao i po nalogu nadležnog Ministarstva, ukoliko takav zahtjev Skupštine, odnosno nalog Ministarstva postoje.
...
9. donosi poslovnik o Turističkog vijeća
...
(2) Dužnost Predsjednika Zajednice obnaša Župan Osječko-baranjske županije. Mandat predsjednika traje do isteka mandata sukladno propisu koji regulira izbore za župana.
...
(2) U trenutku razrješenja župana sukladno propisu kojim se uređuju jedinice regionalne samouprave prestaje njegova dužnost predsjednika Zajednice, a u navedenom slučaju dužnost predsjednika obnaša osoba određena sukladno propisu kojim se uređuju jedinice regionalne samouprave.
...
(1) Skupština Zajednice i Turističko vijeće mogu osnovati privremena radna ili savjetodavna tijela (radno skupine, savjet, komisiju i sl.) radi razmatranja određenog pitanja, davanja mišljenja i prijedloga o značajnim pitanjima iz njihovog djelokruga.
...
(1) Radi obavljanja stručnih i administrativnih poslova Zajednice osnovan je Turistički ured.
...
(4) Direktora turističke zajednice, u slučaju odsutnosti ili spriječenosti, zamjenjuje osoba koju imenuje Turističko vijeće.
...
(1) Direktor Turističkog ureda može biti razriješen i prije isteka mandata:
...
(1) Godišnji program rada Zajednice izrađuje se po jedinstvenoj metodologiji i obveznim uputama koje donosi nadležno Ministarstvo na prijedlog Hrvatske turističke zajednice.
...
(1) Zajednica se obvezuje izraditi izvješće o izvršenju programa rada po jedinstvenoj metodologiji i obveznim uputama koje donosi nadležno Ministarstvo na prijedlog Hrvatske turističke zajednice.
...
(5) Ograničenje iz stavka 4. ovog članka se ne odnosi na troškove plaća radnika zaposlenih u turističko-informativnom centru Zajednice.
...
(1) Statut donosi, uz prethodnu suglasnost Ministarstva nadležnog za turizam, Skupština Zajednice dvotrećinskom većinom svih predstavnika u Skupštini Zajednice.
...
(4) Nakon razmatranja primjedbi i prijedloga Turističko vijeće utvrđuje prijedlog izmjena i dopuna Statuta i upućuje ga nadležnom Ministarstvu na suglasnost. Nakon dobivene suglasnosti na Prijedlog izmjena i dopuna Statuta upućuje ga Skupštini Zajednice na usvajanje.
...
Stupanjem na snagu ovog Statuta prestaje važiti Statut Turističke zajednice Osječko-baranjske županije objavljen u »Narodnim novinama« broj 03/11 i 68/19.
