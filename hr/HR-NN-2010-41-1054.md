...
identifier: "HR-NN-2010-41-1054"
country: "hr"
rank: "pravilnik"
publication_date: "2010-04-07"
last_updated: "2010-04-07"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2010/41/1054"
...
I. OPĆE INFORMACIJE O METODAMA KVANTITATIVNE KEMIJSKE ANALIZE TROKOMPONENTNIH MJEŠAVINA VLAKANA
...
I.3.1.4. Sušionik s ventilatorom za sušenje uzoraka na 105 ± 3 ºC.

I.3.1.5. Analitička vaga preciznosti do 0,0002 g.

I.3.1.6. Soxhlet aparat za ekstrakciju ili drugi pribor koji bi dao istovjetne rezultate.

I.3.2. Reagensi

I.3.2.1. Petroleter, redestiliran, temperature vrelišta 40 ºC do 60 ºC.

I.3.2.2. Drugi reagensi su navedeni u odgovarajućim dijelovima opisa metode. Svi korišteni reagensi moraju biti kemijski čisti.
...
Laboratorijski uzorak za ispitivanje koji je reprezentativan dio laboratorijskog osnovnog uzorka mora biti dovoljno velik da se iz njega mogu dobiti svi uzorci za ispitivanje, svaki mase od barem 1 g.
...
m1 je masa apsolutno suhog prvog uzorka nakon prethodne obrade

m2 je masa apsolutno suhog drugog uzorka nakon prethodne obrade

r1 je masa apsolutno suhog ostatka nakon uklanjanja prve komponente iz prvog uzorka u prvom reagensu

r2 je masa apsolutno ostatka nakon uklanjanja druge komponente iz drugog uzorka u drugom reagensu
...
d3 je faktor korekcije za gubitak mase prve komponente neotopljene s drugim reagensom u drugom uzorku (1)
...
I.8.2. Izračunavanje postotka pojedinih komponenata uz dodavanje dogovorenih trgovačkih dodataka i faktora korekcije za gubitak mase tijekom postupaka prethodneobrade:
...
II.3.2. Eksikator sa silikagel indikatorom
...
II.9.1. Izračunavanje postotaka masa čistog suhog vlakna, ne uzimajući u obzir gubitak u masi vlakna tijekom prethodne obrade:
...
| --- | --- | --- | --- |
| a  b  c | E1  E2  E1 + E2 | E1  E1 + E2  E2 | E1  E1 + E2  E1 + E2 |
...
PRIMJERI IZRAČUNAVANJA POSTOTNIH UDJELA KOMPONENTI ODREĐENIH TROKOMPONENTNIH MJEŠAVINA KORIŠTENJEM NEKIH VARIJANTI OPISANIH U TOČKI I.8.1 DODATKA I

Razmotrimo slučaj mješavine vlakana kod kojeg je kvalitativnom analizom utrvđen slijedeći sirovinski sastav:

1. grebenana vuna,

2. poliamidno vlakno ili nylon,
...
(poliamidno vlakno + pamuk) (r1) = 1,4166 g
...
Obrada alkalnim natrijevim hipokloritom ne uzrokuje nikakav gubitak mase poliamidnog vlakna, dok nebijeljeni pamuk gubi 3 %, stoga d1 = 1,0 i d2 = 1,03.
...
Kako je navedeno u Dodatku II Pravilnika o sirovinskom sastavu i nazivima tekstila, dogovoreni trgovački dodatak je za grebenanu vunu 17,0 %, poliamidno vlakno 6,25 %, pamuk 8,5 %; nebijeljeni pamuk pokazuje gubitak mase od 4 % nakon predobrade s petroleterom i vodom. Stoga:
...
Pretpostavimo da su uporabom varijante 4., tj. postepenim uklanjanjem dvije komponente iz mješavine jednog jedinog uzorka dobiveni sljedeći rezultati:

1. Apsolutno suha masa uzorka nakon prethodne obrade

(m1) = 1,6000 g

2. Apsolutno suha masa ostatka nakon prve obrade alkalnim natrijevim hipokloritom

(viskozno vlakno + pamuk) (r1) = 1,4166 g

3. apsolutno suha masa ostatka nakon druge obrade ostatka r1 sa cink klorid/mravljom kiselinom

(pamuk) (r2) = 0,6630 g

Obrada alkalnim natrijevim hipokloritom ne uzrokuje nikakav gubitak mase viskoznog vlakna, dok neizbijeljeni pamuk izgubi 3 %, stoga d1 = 1,0 i d2 = 1,03.
...
| 2 | Vuna ili dlaka | Poliamidno vlakno 6 ili 6-6 | Pamuk, viskozno, bakarno ili modalno vlakno | 1 i/ili 4 | 2 (alkalni natrijev hipoklorit)  i 4 (80%-tna mravlja kiselina w/w) |
| 3 | Vuna, dlaka ili svila | Određeno klorno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | 1 i/ili 4 | 2 (alkalni natrijev hipoklorit)  i 9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w) |
| 4 | Vuna ili dlaka | Poliamidno vlakno 6 ili 6-6 | Poliestersko, polipropilensko, akrilno ili stakleno vlakno | 1 i/ili 4 | 2 (alkalni natrijev hipoklorit)  i 4 (80%-tna mravlja kiselina w/w) |
| 5 | Vuna, dlaka ili svila | Određeno klorno vlakno | Poliestersko, akrilno, poliamidno ili stakleno vlakno | 1 i/ili 4 | 2 (alkalni natrijev hipoklorit)  i 9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w) |
| 6 | Svila | Vuna ili dlaka | Poliestersko vlakno | 2 | 11 (sumporna kiselina 75% w/w)  i 2 (alkalni natrijev hipoklorit) |
| 7 | Poliamidno vlakno 6 ili 6-6 | Akrilno vlakno | Pamuk, viskozno, bakarno ili modalno vlakno | 1 i/ili 4 | 4 (80%-tna mravlja kiselina w/w)  i 8 (dimetilformamid) |
| 8 | Određeno klorno vlakno | Poliamidno vlakno 6 ili 6-6 | Viskozno, bakarno, modalno vlakno ili pamuk | 1 i/ili 4 | 8 (dimetilformamid)  i 4 (80% mravlja kiselina w/w)  ili  9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w)  i 4 (80%-tna mravlja kiselina w/w) |
| 9 | Akrilno vlakno | Poliamidno vlakno 6 ili 6-6 | Poliestersko vlakno | 1 i/ili 4 | 8 (dimetilformamid)  i 4 (80%-tna mravlja kiselina w/w) |
| 10 | Acetatno vlakno | Poliamidno vlakno 6 ili 6-6 | Viskozno, bakarno, modalno vlakno ili pamuk | 4 | 1 (aceton)  i 4 (80%-tna mravlja kiselina w/w) |
| 11 | Određeno klorno vlakno | Akrilno vlakno | Poliamidno vlakno | 2 i/ili 4 | 9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w)  i 8 (dimetilformamid) |
| 12 | Određeno klorno vlakno | Poliamidno vlakno 6 ili 6-6 | Akrilno vlakno | 1 i/ili 4 | 9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w)  i 4 (80%-tna mravlja kiselina w/w) |
| 13 | Poliamidno vlakno 6 ili 6-6 | Viskozno, bakarno, modalno vlakno ili pamuk | Poliestersko vlakno | 4 | 4 (80%-tna mravlja kiselina w/w)  i 7 (sumporna kiselina 75% w/w) |
| 14 | Acetatno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | Poliestersko vlakno | 4 | 1 (aceton)  i 7 (sumporna kiselina 75% w/w) |
| 15 | Akrilno ili acetatno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | Poliestersko vlakno | 4 | 8 (dimetilformamid)  i 7 (sumporna kiselina 75% w/w) |
...
| 20 | Akrilno vlakno | Vuna, dlaka ili svila | Viskozno, bakarno, modalno vlakno ili pamuk | 1 i/ili 4 | 8 (dimetilformamid)  i 2 (alkalni i natrijev hipoklorit) |
...
| 24 | Određeno klorno vlakno | Viskozno, bakarno ili modalno vlakno vlakno | Pamuk | 1 i/ili 4 | 9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w)  i 3 (cink klorid u mravljoj kiselini)  ili  8 (dimetilformamid)  i 3 (cink klorid u mravljoj kiselini) |
...
| 29 | Acetatno vlakno | Akrilno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | 4 | 1 (aceton)  i 8 (dimetilformamid) |
| 30 | Triacetatno vlakno | Akrilno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | 4 | 6 (diklorometan)  i 8 (dimetilformamid) |
| 31 | Triacetatno vlakno | Poliamidno vlakno 6 ili 6-6 | Viskozno, bakarno, modalno vlakno ili pamuk | 4 | 6 (diklorometan)  i 4 (80% mravlja kiselina w/w) |
| 32 | Triacetatno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | Poliestersko vlakno | 4 | 6 (diklorometan)  i 7 (sumporna kiselina 75% w/w) |
| 33 | Acetatno vlakno | Poliamidno vlakno 6 ili 6-6 | Poliestersko ili akrilno vlakno | 4 | 1 (aceton)  i 4 (80% mravlja kiselina w/w) |
| 34 | Acetatno vlakno | Akrilno vlakno | Poliestersko vlakno | 4 | 1 (aceton)  i 8 (dimetilformamid) |
| 35 | Određeno klorno vlakno | Viskozno, bakarno, modalno vlakno ili pamuk | Poliestersko vlakno | 4 | 8 (dimetilformamid)  i 7 (sumporna kiselina 75% w/w)  ili  9 (otopina ugljičnog disulfida u acetonu 55,5/44,5 w/w)  i 7 (sumporna kiselina 75% w/w) |
| (1) Kada se koristi varijanta 4., prvo treba ukloniti prvu komponentu koristeći prvi reagens. |  |  |  |  |  |

[1] Vrijednosti d su navedene u odgovarajućim odjeljcima Pravilnika koje se odnose na razne metode analiza dvokomponentnih mješavina.
