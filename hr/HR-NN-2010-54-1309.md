...
identifier: "HR-NN-2010-54-1309"
country: "hr"
rank: "pravilnik"
publication_date: "2010-05-03"
last_updated: "2010-05-03"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2010/54/1309"
...
a) bitni zahtjevi kojima mora udovoljavati operator zrakoplova (u daljnjem tekstu: operator) za izvođenje letačkih operacija (Essential requirements for air operations) (Part OPS – Pododjeljak A – OPS.GEN)

b) dodatni i specifični zahtjevi kojima mora udovoljavati operator za izvođenje komercijalnih operacija (Part OPS – Pododjeljak C – OPS.COM)
...
g) zahtjevi kojima mora udovoljavati član tehničke posade u NVIS operacijama, koji nije član letačke ili kabinske posade (Part OR – Pododjeljak OPS, Sekcija VII)

h) zahtjevi kojima mora udovoljavati operator kako bi kontrolirao umor i udovoljio zahtjevima i ograničenjima vremena dužnosti, letenja i odmora za članove posade (letačke, kabinske i tehničke posade) (Part OR – Pododjeljak OPS, Sekcija VIII).

(2) Odredbe ovoga Pravilnika ne primjenjuju se na komercijalni zračni prijevoz avionom i helikopterom.
...
(2) Iznimno od stavka 1. ovog članka, pojmovi »Zajednica«, »zakonodavstvo Zajednice« i »država članica« iz Dodatka ovoga Pravilnika, čitat će se u skladu sa točkama 2. i 3. Dodatka II ECAA Sporazuma.
...
1. odgovarajućim Zajedničkim zrakoplovnim propisima (Joint Aviation Requirements – JAR’s), koji su povezani s njihovim operacijama i to:

a) JAR-26: – Additional Airworthiness Requirements for Operations; Dodatni plovidbeni propisi za operacije;
...
d) JAR-MMEL/MEL – Master Minimum Equipment List/Minimum Equipment List; Glavna lista minimalne opreme/Lista minimalne opreme.
...
Ovaj Part definira primjenjive zahtjeve kojima mora udovoljavati operator kako bi se osiguralo odvijanje operacija zrakoplova u skladu sa člankom 8. i Aneksom IV »Bitni zahtjevi za letačke operacije« Uredbe 216/2008 koja je sadržana u Dodatku Pravilnika o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa.
...
(16) FATO (Final Approach and take off area): definirano područje za operacije helikoptera, nad kojim je dovršena završna faza prilaza za lebdenje ili slijetanje, te se s njega može započeti manevar za uzlijetanje. Za helikoptere koji operiraju u kategoriji performansi klase 1, ova definirana površina uključuje raspoloživu površinu za prekinuto uzlijetanje;

(17) Faza leta na ruti (En-route phase): dio leta od kraja uzlijetanja i inicijalne faze penjanja do početka faze prilaza i faze slijetanja;

(18) Faza prilaza i slijetanja ( Approach and landing phase): dio leta od 300 m (1000 ft) iznad visine FATO-a, ukoliko je let planiran da prijeđe tu visinu, ili od početka snižavanja u drugim slučajevima, do slijetanja ili do točke prekinutoga slijetanja;

(19) HEMS operativna površina: površina koju izabere zapovjednik tijekom HEMS letova, za operacije helikopterskim vitlom, slijetanje i uzlijetanje;

(20) Helikopterska platforma (Helideck): FATO smješten na plutajućoj ili fiksnoj strukturi koja nije na kopnu;

(21) Helikopterski let u operacijama vitlom (Helicopter Hoist Operations (HHO) flight): let helikopterom koji se obavlja temeljem odobrenja za HHO čija je svrha omogućavanje transporta osoba i/ili stvari helikopterskim vitlom;

(22) HHO izvan kopna (HHO Offshore): let helikopterom koji se obavlja temeljem odobrenja za HHO let, a čija je svrha omogućiti prijevoz osoba i/ili tereta uz pomoć helikopterskog vitla sa ili na plovilo ili konstrukciju u morskom području ili na samo more;

(23) HHO putnik: osoba koju se premješta helikopterskim vitlom;

(24) Hidroavion: zrakoplov nepokretnih krila koji je namijenjen uzlijetanju i slijetanju na vodu i uključuje amfibije kada se upotrebljavaju kao hidroavioni;

(25) Instrumentalni meteorološki uvjeti (IMC): meteorološki uvjeti izraženi u smislu vidljivosti, udaljenosti od oblaka, i visine baze oblaka (kako je definirano u ICAO Aneksu 2), manji od minimuma specificiranih za vizualne meteorološke uvjete (VMC);

(26) Izdignuti FATO (Final Approach and take off area): zona koja je izdignuta najmanje 3 metra od okolne površine;

(27) Jedrilica: zrakoplov teži od zraka koji je održavan u letu dinamičkim reakcijama zraka na njegovim nepokretnim uzgonskim površinama, a čiji slobodni let ne ovsi o motoru;

(28) Jedrilica s pomoćnim motorom: zrakoplov opremljen jednim ili više motora, a ima osobine jedrilice, kada motor(i) ne rade;

(29)  Kategorija A helikoptera: višemotorni helikopter s motorima i sustavom za otkrivanje kvarova, projektiranim kako je specificirano u CS-27/29 ili drugom prikladnom dokumentu, te s informacijama o performansama u helikopterskom letačkom priručniku koje su bazirane na otkazu kritičnog motora, a koje osiguravaju prikladnu određenu površinu (designated surface area) i prikladne performanse za siguran nastavak leta u slučaju otkaza motora;

(30) Kategorija B helikoptera: jednomotorni helikopter ili višemotorni helikopter koji u potpunosti ne udovoljava zahtjeve za kategoriju A helikoptera. Kategorija B helikoptera nema osiguranu sposobnost zadržavanja visine leta (stay up) za slučaj otkaza motora i kada se pretpostavlja nepredviđeno slijetanje;

(31) Komercijalni zračni prijevoz: prijevoz putnika, tereta ili pošte za naplatu ili najam;

(32) Komercijalna operacija: radovi iz zraka i bilo koja operacija zrakoplova, u zamjenu za naplatu ili drugu vrstu naknade, koja je dostupna javnosti ili koja se, ako nije dostupna javnosti, obavlja u skladu s ugovorom između operatora i korisnika usluge, pri čemu korisnik usluge nema nikakvu kontrolu nad operatorom, a koja nije komercijalni zračni prijevoz. Osposobljavanje kandidata za stjecanje dozvole i ovlaštenja privatnog pilota koje provode neprofitabilne organizacije (npr. aeroklubovi i udruge građana) ne smatra se komercijalnom operacijom;

(33) Složeni zrakoplov na motorni pogon:
...
(34) Konfiguracija s najvećim brojem putničkih sjedišta: najveći utvrđeni broj putničkih sjedišta pojedinog zrakoplova za potrebe izvođenja operacija, koji ne uključuje sjedišta za posadu. Taj broj može biti manji od certificiranog najvećega broja putničkih sjedišta zrakoplova;

(35) Kontrolirani let: bilo koji let koji je podložan odobravanju službe kontrole leta;

(36) Kontrolna lista prihvata: dokument koji se koristi kao pomoć kod vanjskog pregleda paketa s opasnom robom i pripadajućih dokumenata kako bi ustanovili udovoljavanje svim primjenjivim zahtjevima;

(37) Kopneni avion: zrakoplov nepokretnih krila konstruiran za uzlijetanje i slijetanje na kopno, a uključuje amfibije kada se njima operira kao kopnenim avionima;

(38) Kritična faza leta: zalijetanje, putanja uzlijetanja, finalni prilaz, slijetanje uključujući protrčavanje, produžavanje (go-around) i bilo koju drugu fazu leta koju odredi zapovjednik. Kod helikoptera se pod kritičnom fazom leta podrazumijeva i voženje;

(39) Ljudska izvedba (Human performance): ljudske sposobnosti i ograničenja koji imaju utjecaj na sigurnost i učinkovitost zrakoplovnih operacija;

(40) Let hitne medicinske pomoći helikopterom (HEMS flight): let helikopterom koji se obavlja temeljem odobrenja za HEMS, čija je svrha pružanje hitne medicinske pomoći, gdje je neophodan trenutan i brz prijevoz:
...
(41) Lokalne operacije: letačke operacije koje se izvode unutar lokalnog i geografski određenog područja, a koje:
...
(42) NVIS let: noćni let u vizualnim meteorološkim uvjetima s posadom koja koristi NVG u helikopteru koji leti pod NVIS odobrenjem;

(43) Malo dijete (Infant): osoba mlađa od 24 mjeseca;

(44) Masa na uzlijetanju: predstavlja ukupnu masu, uključujući sve što se prevozi na početku uzlijetanja helikoptera i na početku zalijetanja u svrhu uzlijetanja za avione;

(45) Mjesto HHO premještanja: određeno područje na kojem helikopter obavlja premještanje helikopterskim vitlom;

(46) Mjesto od javnog interesa: mjesto koje se koristi isključivo za operacije u svrhu javnog interesa;

(47) Mokra uzletno sletna staza: uzletno-sletna staza čija je površina pokrivena vodom, ili slično, u manjem obimu od specificiranoga u definiciji Onečišćena / kontaminirana staza ili kada ima dovoljno vlage na površini uzletno – sletne staze koja uzrokuje da staza izgleda reflektirajuće ali bez značajnih područja (dijelova) gdje se zadržava voda;

(48) Naočale za gledanje u uvjetima noćne vidljivosti (NVG): naprava, dvogled, koji se stavlja na glavu, pojačivač svjetla, koji poboljšava sposobnost motrenja zemaljskih orijentira noću;

(49) Naseljena područja: grad, mjesto, naselje, odnosno bilo koje područje koje se sadržajno koristi za stanovanje, javne ili rekreacijske svrhe;

(50) Naseljeno neprijateljsko okruženje: neprijateljsko okruženje u naseljenom području;

(51) Navigacijske specifikacije (Navigation Specification): skup zahtjeva za zrakoplov i posadu neophodan za podršku u operacijama pri navigaciji zasnovanoj na performansama u sklopu definiranoga zračnoga prostora. Postoje dvije vrste navigacijskih specifikacija:

(a) RNP specifikacije: navigacijske specifikacije bazirane na prostornoj navigaciji, koja uključuje zahtjeve za praćenje performansi i upozoravanje, a označene su prefiksom RNP, npr. RNP 4, RNP APCH;

(b) RNAV specifikacije: Navigacijske specifikacije bazirane na prostornoj navigaciji, koja uključuje zahtjeve za praćenje performansi i upozoravanje, a označene su prefiksom RNAV, npr. RNAV 5, RNAV 1;

(52) Navigacija bazirana na performansama (PBN – Performance based navigation): prostorna navigacija bazirana na zahtjevima performansi za operacije zrakoplovom duž ATS rute, na instrumentalnoj prilaznoj proceduri ili u određenom zračnom prostoru;

(53) Nekomercijalna operacija: bilo koja operacija zrakoplova koja se ne obavlja za naknadu;

(54) Nenaseljeno neprijateljsko okruženje: neprijateljsko okruženje u izvan naseljenog područja;

(55) Neprijateljsko okruženje:
...
(ii) U svakom slučaju, slijedeća područja smatraju se neprijateljskim okruženjem:
...
(56) Noć: vremensko razdoblje između kraja građanskog večernjeg sumraka i početka građanskog jutarnjeg sumraka. Građanski sumrak završava uvečer kada je centar sunčevog kruga 6 stupnjeva ispod horizonta i počinje ujutro kada je centar sunčevog kruga 6 stupnjeva ispod horizonta;

(57) Odgovarajući aerodrom: aerodrom na kojem zrakoplov može obavljati operacije, vodeći računa o primjenjivim zahtjevima performansi i karakteristikama uzletno sletne staze;

(58) Odleđivanje: postupak kojim se mraz, led, snijeg ili lapavica otklanjaju sa zrakoplova u svrhu čišćenja površina;

(59) Odrasla osoba: osoba koja ima 12 ili više godina;

(60) Odredišni alternativni aerodrom: alternativni aerodrom prema kojem zrakoplov može nastaviti let ako bi postalo nemoguće ili nepreporučljivo slijetanje na planirani odredišni aerodrom;

(61) Određena točka nakon uzlijetanja (DPATO – Defined point after take off): tijekom uzlijetanja i inicijalne faze penjanja, točka prije koje nije osigurana sposobnost helikoptera za siguran nastavak leta, sa neučinkovitom pogonskom jedinicom, te može biti nužno prisilno slijetanje;

(62) Održavanje: izvođenje zadataka koji se zahtijevaju kako bi osigurali kontinuiranu plovidbenost zrakoplova, uključujući bilo koju kombinaciju generalne revizije, inspekcije, zamjene, otklanjanja kvara i izvršenje modifikacije ili popravka;

(63) Onečišćena/Kontaminirana uzletno sletna staza: staza čija je površina u omjeru većem od 25% od zahtijevane dužine i širine koja se koristi pokrivena:

(i) Površinom vode dubine veće od 3mm, lapavicom ili mekim snijegom koji odgovara vrijednosti većoj od 3mm vode.
...
(64) Opasna roba (Dangerous goods): predmeti i tvari koje su u stanju prouzročiti značajan rizik za zdravlje, sigurnost, imovinu i okoliš i koje se nalaze na popisu opasnih roba u Tehničkim instrukcijama ili su klasificirane u skladu s Tehničkim instrukcijama;

(65) Operacije generalne avijacije (General aviation operation): operacije zrakoplova koje nisu komercijalni zračni prijevoz ili radovi iz zraka;

(66) Operacije izvan kopna: operacije koje uobičajeno imaju pretežni dio leta koji se odvija iznad površine mora, prema ili od lokacija izvan kopna. Takve operacije uključuju, ali nisu ograničene na, podršku lokacijama izvan kopna, naftnim, plinskim i mineralnim postrojenjima i premještanju pomorskih pilota (sea pilot);

(67) Operativna baza helikopterske hitne medicinske pomoći (HEMS Operating Base): aerodrom na kojem HEMS posada i helikopter, mogu biti u pripremi za pružanje hitne medicinske pomoći helikopterom;

(68) Operativna površina: mjesto odabrano od operatora ili zapovjednika za slijetanje, uzlijetanje i/ili izvođenje HHO operacija;

(69) Operativne specifikacije: odobrenja, uvjeti i ograničenja u vezi sa svjedodžbom operatora zrakoplova, ovisni o uvjetima sadržanima u operativnom priručniku;

(70) Operator zrakoplova: fizička ili pravna osoba koja se bavi operiranjem zrakoplova ili nudi usluge operiranja zrakoplova.

(71) Performanse klase 1: one performanse kada u slučaju otkaza kritične pogonske jedinice, helikopter može sletjeti unutar raspoložive duljine za prekinuto uzlijetanje ili sigurno nastaviti let do područja odgovarajućeg za slijetanje, zavisno o trenutku kada se otkaz dogodio;

(72) Performanse klase 2: one performanse kada u slučaju otkaza kritične pogonske jedinice, helikopter raspolaže performansama dovoljnim da sigurno nastavi let, osim u slučaju kada se otkaz dogodi u ranoj fazi manevra uzlijetanja ili kasnoj fazi manevra slijetanja, kada prisilno slijetanje može biti potrebno;

(73) Performanse klase 3: znače one performanse kada u slučaju otkaza kritične pogonske jedinice u bilo kojem trenutku tijekom leta, prisilno slijetanje može biti potrebno za više motorni helikopteri i bit će potrebno u jednomotornom helikopteru;

(74) Principi ljudskoga faktora (Human factor principles): principi koji se primjenjuju na zrakoplovni dizajn, certifikaciju, osposobljavanje, operacije i održavanje, a koji zahtijevaju sigurno povezivanje čovjeka i drugih komponenti sustava uzimajući u obzir ljudsku izvedbu;

(75) Prostorna navigacija – Area navigation (RNAV): metoda navigacije koja omogućava operacije zrakoplova na bilo kojoj željenoj putanji leta unutar pokrivenosti zemaljskih i drugih navigacijskih sredstava ili unutar ograničenja vlastitih navigacijskih sredstava, ili njihovih kombinacija;

(76) Prijateljsko okruženje: okruženje u kojem:
...
(77) Procedure smanjene vidljivosti: procedure koje se primjenjuju na aerodromu u svrhu omogućavanja sigurnih operacija u uvjetima smanjene vidljivosti, a za koje se zahtijeva posebno odobrenje;

(78) Program održavanja (Maintenance programme): dokument koji opisuje specifične zadatke redovnoga održavanja i učestalost njihovog izvođenja i pripadajuće postupke, kao što su program pouzdanosti, neophodne za izvođenje sigurnih operacija zrakoplova na koje se odnosi;

(79) Putanja pri uzlijetanju (Take-off flight path): vertikalna i horizontalna putanja s otkazom kritične pogonske jedinice, od određene točke u uzlijetanju do 1000 ft iznad površine;

(80) Putnik neprihvatljivog ponašanja: putnik koji ne poštuje pravila ponašanja u zrakoplovu ili koji ne postupa u skladu sa uputama članova posade;

(81) Radovi iz zraka (Aerial work): operacije zrakoplova u kojima se zrakoplov koristi za specijalizirane zadatke kao što su poljoprivreda, gradnja, snimanje, nadzor, izviđanje i patroliranje, potragu i spašavanje, zračno oglašavanje, itd.;

(82) Raspoloživa duljina za uzlijetanje (TODA): raspoloživa duljina za zalijetanje u svrhu uzlijetanja uvećana za duljinu ravnine bez prepreka (clearway);

(83) Raspoloživa duljina za slijetanje (LDA): duljina uzletno sletne staze koja je, od nadležnih aerodromskih tijela, proglašena raspoloživom i odgovarajućom za protrčavanje aviona pri slijetanju;

(84) Raspoloživa duljina za zalijetanje (TORA): raspoloživa duljina uzletno sletne staze koju je nadležno tijelo objavilo i koja je odgovarajuća za zaletavanje zrakoplova pri uzlijetanju;

(85) Serija letova: slijed letova, koji počinju i završavaju:
...
(86) Sigurno prisilno slijetanje: neizbježno slijetanje na kopno ili vodenu površinu u kojem se ne očekuje vjerojatnost ozljeđivanja osoba u zrakoplovu ili na površini na koju se slijeće;

(87) Sjedište tvrtke: glavni ured ili registrirani ured zrakoplovnog operatora Zajednice u državi članici unutar koje operator Zajednice izvršava osnovne financijske funkcije, operativnu kontrolu, uključujući upravljanje kontinuiranom plovidbenošću;

(88) Specijalni let prema pravilima vizualnoga letenja (Special VFR): VFR let odobren od službe kontrole leta, za izvođenje unutar kontrolirane zone u meteorološkim uvjetima koji su ispod minimalnih uvjeta za vizualno letenje;

(89) Sprječavanje zaleđivanja (Anti –icing): postupak kojim tretirane površine zrakoplova na ograničeno vrijeme zadržavaju – (Hold over time) zaštitu od pojave leda i njegovoga nakupljanja;

(90) Standardna kategorija I: precizni instrumentalni prilaz i slijetanje uz korištenje ILS, MLS ili PAR sustava s visinom odluke ne manjom od 200 ft i s vidljivošću duž uzletno sletne staze ne manjom od 550 m za zrakoplove i 500 m za helikoptere;

(91) Suha operativna masa (Dry operating mass): ukupna masa zrakoplova koji je spreman za određeni tip operacije, isključivši iskoristivo gorivo i teret (traffic load). Suha operativna masa uključuje:
...
(92) Suha uzletno sletna staza: staza koja nije ni mokra ni onečišćena, i uključuje popločene staze koje su posebno pripremljene sa žljebovima ili poroznom površinom te održavane tako da i u uvjetima kada je prisutna vlaga omogućuju efikasno »suho kočenje«;

(93) Sustav poboljšane vidljivosti (EVS- Enhanced Vision System): elektronska sredstva koja su u stanju projicirati odraz vanjskih prizora u realnom vremenu, posredstvom senzora za prikaz;

(94) Sustav snimanja u uvjetima noćne vidljivosti (NVIS): objedinjavanje svih elemenata potrebnih za uspješnu i sigurnu upotrebu naočala za gledanje u uvjetima noćne vidljivosti tijekom letenja helikoptera. Sustav uključuje najmanje: NVG, NVIS osvjetljenje, komponente helikoptera (kao što su radio visinomjer, sustav za vizualno upozoravanje i sustav za zvučno upozoravanje) osposobljavanje i kontinuiranu plovidbenost;

(95) Teret (Traffic load): ukupna masa putnika, osoba koje nisu članovi posade, prtljage, tereta, specijalističke opreme koja se prevozi i balasta;

(96) Uslužno osoblje hitnih službi na zemlji (Ground Emergency Service Personell): osoblje (policija, vatrogasci, itd.) koje je uključeno u hitnu medicinsku pomoć helikopterom (HEMS) i čije zadaće u bilo kojem obimu obuhvaćaju operacije helikoptera;

(97) Uzlijetanje u uvjetima smanjene vidljivosti: uzlijetanje u uvjetima kada je vidljivost duž uzletno sletne staze manja od 400 m;

(98) VEF: oznaka brzine pri kojoj se pretpostavlja otkaz kritičnog motora tijekom uzlijetanja;

(99) V1: maksimalna brzina u uzlijetanju pri kojoj pilot mora poduzeti prve radnje (npr. početi kočiti, smanjiti potisak, uključiti zračne kočnice) da zaustavi avion unutar duljine za zaletavanje-zaustavljanje.V1 je isto tako minimalna brzina u uzlijetanju s otkazom kritičnog motora pri VEF , pri kojoj pilot može nastaviti uzlijetanje i postići zahtijevanu visinu iznad površine uzlijetanja unutar duljine za uzlijetanje;

(100) Vidljivost duž uzletno sletne staze (RVR): razdaljina u kojoj pilot zrakoplova na centralnoj liniji uzletno sletne staze vidi oznake za označavanje površine uzletno sletne staze ili svjetla koja obilježavaju uzletno sletnu stazu ili njenu centralnu liniju;

(101) Visina iznad praga staze: visina određena od imatelja (dodatnog) certifikata tipa na 50 ft, ili drugu vrijednost od 35 do 50 ft;

(102) Vrijeme zadržavanja (Hold-over Time (HoT)): predviđeni vremenski period u kome se očekuje da će tekućina za sprječavanje zaleđivanja spriječiti stvaranje inja ili leda i nakupljanje snijega na tretiranim površinama zrakoplova na zemlji u prevladavajućim okolnim uvjetima;

(103) VTOSS: minimalna brzina pri kojoj se zrakoplov mora moći penjati sa neučinkovitom kritičnom pogonskom jedinicom, a kada preostale pogonske jedinice rade unutar odobrenih operativnih ograničenja;

(104) Zapovjednik (Pilot in command): pilot određen od strane operatora, ili u slučaju generalne avijacije, vlasnika, koji zapovijeda i zadužen je za sigurno izvođenje leta;

(105) Zahtijevana duljina za uzlijetanje helikoptera (TODRH): horizontalna duljina potrebna od početka uzlijetanja do točke u kojoj su postignuti VTOSS, odabrana visina i pozitivan gradijent penjanja, uz otkaz kritične pogonske grupe prepoznat u TDP – točka odluke u uzlijetanju (Take off decision point), s preostalim operativnim pogonskim grupama unutar odobrenih operativnih ograničenja;

(106) Zrakoplov: svaka naprava koja se održava u atmosferi zbog reakcije zraka, osim reakcije zraka u odnosu na Zemljinu površinu.

OPS.GEN.015 Odgovornosti i ovlaštenja zapovjednika

SVI ZRAKOPLOVI

(a) Zapovjednik mora biti odgovoran:

(1) Za započinjanje, nastavak, prekid, ili odstupanja od planiranoga leta, kada je uključen u nekomercijalne operacije zrakoplovom koji nije složene konstrukcije na motorni pogon;
...
(c) Zapovjednik mora, što je prije moguće, dojaviti nadležnoj jedinici kontrole leta (ATS), bilo koji opasni događaj u letu, koji može utjecati na sigurnost drugih zrakoplova.
...
(a) Članovi posade moraju biti odgovorni za pravilno izvršavanje svojih dužnosti koje se odnose na sigurnost zrakoplova i osoba u njemu, u skladu sa primjenjivim zahtjevima, i tamo gdje je to primjenjivo, a u skladu sa operativnim priručnikom.
...
(f) Članovi posade ne smiju započeti sa dužnosti na zrakoplovu ukoliko su umorni ili postoji vjerojatnost umora, ili se osjećaju nespremni, u mjeri zbog koje se može ugroziti let.
...
(a) Prijevoz opasnih roba zrakom mora se obavljati u skladu sa važećim izdanjem Tehničkih instrukcija za siguran prijevoz opasnih roba zrakom, objavljenih odlukom vijeća ICAO-a (ICAO dokument 9284-AN/905).

(b) Opasne robe smije prevoziti samo operator koji ima odobrenje za takav prijevoz, te u skladu sa primjenjivim propisima koji se odnose na opasne robe i OPS.SPA.DG, osim kada:
...
Osim kada organizacija za osposobljavanje odobrena u skladu s Partom OR, provodi obuku u letu, za vrijeme prijevoza putnika ili tereta ili kada se izvode komercijalne operacije, ne smije se simulirati slijedeće:

(1) Izvanredni postupci ili postupci u hitnim situacijama (Emergency) koje zahtijevaju primjenu izvanrednih ili postupaka u hitnosti; ili

(2) Meteorološki uvjeti za instrumentalno letenje (IMC) uporabom pomagala za simuliranje tih uvjeta.
...
(d) Operator helikoptera mora navesti sjedišta koja mogu biti zauzeta od strane odrasle osobe sa djetetom, pravilno osiguranih sigurnosnim pojasom.
...
OPS.GEN.147 Operativni minimumi za pravila vizualnog letenja (VFR)

(a) Letenje po pravilima vizualnog letenja mora se obavljati u skladu s pravilima vizualnog letenja i Tablicom 1.

Tablica 1 – Minimalne vidljivosti za VFR operacije

| Klasa zračnog prostora | ABCDE* | F | G |
| --- | --- | --- | --- |
|  |  | Iznad 900 m (3000 ft) AMSL ili iznad 300 m (1000ft) iznad terena, što je više | Na i ispod 900 m (3000 ft) AMSL ili 300 m (1000 ft) iznad terena, što je više |
| Udaljenost od oblaka | 1500 m horizontalno  300m (1000ft) vertikalno | Bez oblaka i vidljivost tla |  |
| Vidljivost u letu | 8 km na i iznad 3050 m (10000 ft) AMSL**  5 km ispod 3050 m (10000 ft) AMSL** | 5 km*** |  |

*VMC minimumi za zračni prostor klase A uključeni su kao smjernica, no ne podrazumijevaju prihvatljivost VFR letova u zračnom prostoru klase A.

** Kada je visina prolazne visine niža od 3050 m (10000 ft) AMSL, nivo leta 100 mora se koristiti umjesto 10000 ft.

*** Vidi (c) (1) ispod.

(a) Posebni VFR letovi ne smiju se započeti kada je vidljivost manja od 3 km i ne smiju se odvijati kada je vidljivost manja od 1,5 km.

HELIKOPTERI

(b) Helikopterima se moraju izvoditi operacije u uvjetima vidljivosti ne manjima od:
...
(c) U zračnom prostoru klase G kada se leti između platformi gdje je područje iznad vode manje od 10 nm, VFR letovi se izvode prema Tablici 2.
...
(b) Alternativni aerodrom pri uzlijetanju mora biti na slijedećim udaljenostima od aerodroma uzlijetanja:

(1) Zrakoplovi sa dvije pogonske jedinice: udaljenost ne veća od one jednake vremenu od jednoga sata leta na brzini krstarenja sa jednim motorom; i
...
(d) Za letove koji se izvode u skladu sa instrumentalnim pravilima letenja (IFR), najmanje jedan odredišni alternativni aerodrom mora biti odabran i naveden u planu leta, osim kada:
...
(2) Za helikoptere: dostupne trenutne meteorološke informacije ukazuju da će slijedeći meteorološki uvjeti postojati dva sata prije i dva sata poslije očekivanoga vremena dolaska:

(i) Baza oblaka od najmanje 130 metara (400 ft) iznad minimuma za postupke instrumentalnoga prilaza;

(ii) Vidljivost od najmanje 1500m više od minimuma primjenjivoga za postupak; ili
...
(iii) Za avione: dostupne trenutne meteorološke informacije ukazuju da će slijedeći meteorološki uvjeti postojati dva sata prije i dva sata poslije očekivanoga vremena dolaska:
...
Za svaki let koji se izvodi u skladu sa instrumentalnim pravilima letenja (IFR), moraju biti utvrđene minimalne visine nadvišenja terena za rutu po kojoj se leti.
...
Operacije se moraju obavljati u skladu sa ograničenjima na rutama i područjima operacija onako kako je to određeno od strane države koja se nadlijeće.
...
(c) Prilaz se može nastaviti ispod DA/H ili MDA/H i slijetanje se može završiti ukoliko je jedna od slijedećih vizualnih referenci za uzletno sletnu stazu koja se namjerava koristiti, utvrđena i vidljiva na DA/H ili MDA/H:
...
(a) Sukladno točki 2.a.7. Aneksa IV »Bitni zahtjevi za letačke operacije« Uredbe 216/2008 koja je sadržana u Dodatku Pravilnika o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa, moraju se nositi najmanje slijedeće minimalne količine rezervnog goriva za letove po vizualnim pravilima letenja (VFR) i goriva za letove po instrumentalnim pravilima letenja (IFR).
...
ZRAKOPLOVI KOJI SE KORISTE U KOMERCIJALNIM OPERACIJAMA

(c) Za komercijalne operacije, dokumentacija za masu i uravnoteženje mora biti izrađena prije svakog leta, navodeći teret i njegov raspored.
...
(a) Prilikom određivanja maksimalne dozvoljene mase pri uzlijetanju, slijedeće mora biti uzeto u obzir:
...
b) Oprema i instrumenti zahtijevani u Part OPS moraju biti odobreni, osim kako je navedeno u (c), i ugrađeni u skladu s Part-21

c) Instrumenti i oprema zahtijevani u Part OPS koji ne moraju biti odobreni u skladu s Part-21, kao i bilo koja dodatna oprema koja nije zahtijevana Part OPS, ali se nosi na letu, mora udovoljiti slijedećem:
...
d) Instrumenti i oprema moraju biti spremni za upotrebu ili dostupni s pozicije na kojoj član letačke posade koji ih treba koristiti sjedi.

e) Instrumenti i oprema koju koristi letačka posada mora biti raspoređena tako da joj omogući da vide očitanja dostupna za trenutnu upotrebu sa svojih pozicija, s minimalnim praktičnim odstupanjem od položaja i linije gledanja koji normalno zauzimaju prilikom pogleda naprijed duž putanje leta.

f) Sva oprema za slučaj opasnosti mora biti lako dostupna za trenutnu upotrebu.
...
(2) Iznad vode i bez vizualnog kontakta sa kopnom;ili
...
(d) Baloni kojima se izvode operacije noću moraju, pored udovoljavanja OPS.GEN.510(d) i (e), kako je primjenjivo, biti opremljeni s:
...
(1) Opremom za davanje zvučnih signala, kako je propisano Međunarodnim propisima za spriječavanje sudara na moru;
...
(c) Helikopteri moraju biti opremljeni s:

(1) Najmanje jednim automatskim odašiljačem za slučaj opasnosti; i

(2) Jednim ELT-om za preživljavanje (ELT(S)) u čamcu za spašavanje ili pojasu za spašavanje kada helikopter izvodi operacije :

(i) Performanse klase 1 ili 2 u letu iznad vodene površine na udaljenosti koja odgovara vremenu leta duljem od 10 minuta pri normalnoj brzini krstarenja; ili

(ii) Performanse klase 3 u letu iznad vodene površine na udaljenosti koja odgovara vremenu leta duljem od tri minute pri normalnoj brzini krstarenja
...
(1) Opremom za davanje signala poziva u pomoć pirotehničkim sredstvima opisanima u ICAO Aneks II (distress signal)
...
OPS.GEN.440 Letovi na velikom visinama – kisik

SVI ZRAKOPLOVI

(a) Zrakoplovi koji lete iznad visina na kojima je visina po tlaku u putničkom prostoru iznad 10 000 stopa moraju biti opskrbljeni sa dovoljno kisika za disanje za opskrbu:
...
Kada su na trupu zrakoplova označena područja pogodna spsilačkim službama za nasilno otvaranje u slučaju hitnosti, oznake moraju biti kako je prikazano u slici 1.
...
(c) Turbinski avioni moraju biti opremljeni s ACAS-om minimalnih performansi ACAS II kada imaju:

(1) za nekomercijalne operacije najveću certificiranu masu u uzlijetanju preko 15 000 kg ili najveću konfiguraciju putničkih sjedala više od 30; ili

(2) za komercijalne operacije najveću certificiranu masu u uzlijetanju preko 5 700 kg ili najveću konfiguraciju putničkih sjedala više od 19.

OPS.GEN. 465.A Sustav indikacije mape terena i upozoravanja (o opasnom približavanju preprekama) – (TAWS) – avioni

(a) Turbinski avioni sa najvećom certificiranom masom u uzlijetanju većom od 5 700 kg, ili s najvećom konfiguracijom putničkih sjedala više od 9 moraju biti opremljeni s TAWS koji udovoljava zahtjevima opreme klase A.
...
(1) sigurnosnim pojasevima sa ramenim vezama i s uređajem koji će automatski zategnuti tijelo u slučaju naglog usporavanja na svakom sjedalu člana posade zrakoplova; i
...
(b) Sigurnosni pojasevi s ramenim vezama moraju imati sustav otpuštanja u jednoj točci.

HELIKOPTERI

(c) Helikopteri koji se koriste u komercijalnim operacijama i složeni helikopteri na motorni pogon kojima je prvi certifikat o plovidbenosti izdan nakon 31.07.1999. moraju biti opremljeni sa sigurnosnim pojasevima sa dijagonalnom ramenom vezom ili sigurnosnim ramenim vezama za svakog putnika starijeg od 24 mjeseca.
...
(b) Kada avion ima najveću konfiguraciju putničkih sjedala veću od 200, dodatna sjekira ili željezna poluga mora biti na avionu smještena u ili što bliže prostoru zadnje kuhinje, na mjestu koje nije vidljivo putnicima.
...
(1) s najvećom certificiranom masom u uzlijetanju većom od 5 700 kg, i za koje je prvi certifikat o plovidbenosti izdan nakon 01.01.2005; i
...
moraju biti opremljeni sa uređajem za snimanje podataka o letu (FDR) koji koristi metodu digitalnog snimanja i pohrane podataka i ima mogućnost isčitavanja pohranjenih podataka.
...
(1) s najvećom certificiranom masom u uzlijetanju većom od 3 175 kg i za koje je prvi certifikat o plovidbenosti izdan nakon 01.01.2005.;

(2) s najvećom certificiranom masom u uzlijetanju većom od 7 000 kg i za koje je prvi certifikat o plovidbenosti izdan nakon 01.08.1999. sve do kraja i uključujući 31.12.2004.; i

(3) sa najvećom certificiranom masom u uzlijetanju većom od 7 000 kg i za koje je prvi certifikat o plovidbenosti izdan nakon 31.12.1988.; sve do kraja i uključujući 31.07.1999.
...
OPS.GEN.495 Uređaj za snimanje zvukova u pilotskoj kabini – Avioni i helikopteri
...
(1) zadnja dva sata za avione kojima je certifikat o plovidbenosti izdan nakon 01.01.2003.; ili
...
(1) zadnjih sat vremena za helikoptere kojima je prvi individualni certifikat o plovidbenosti izdan nakon 31.07.1999.; ili
...
(a) Avioni i helikopteri kojima je izdan prvi certifikat o plovidbenosti 08.04.2012 ili kasnije, koji imaju mogućnost komunikacije podatkovnom vezom (data link communication) i za koje se zahtijeva da budu opremljeni sa CVR-om, moraju biti opremljeni i opremom za snimanje sljedećeg, ako je primjenjivo:
...
(b) Snimač mora koristiti digitalnu metodu snimanja i pohrane podataka i informacija i metodu za isčitavanje tih podataka. Metoda snimanja mora omogućiti usporedbu s podacima snimljenima na zemlji
...
Zrakoplov mora biti opremljen transponderom koji šalje podatak barometarske visine (SSRtransponder) kada se to zahtijeva propisima.
...
(5) izvornik ili kopija Svjedodžbe operatora zrakoplova;
...
Pododjeljak C – Komercijalne operacije koje nisu komercijalni zračni prijevoz

Sekcija I – Opći zahtjevi

OPS.COM.005. Područje primjene

Ovaj pododjeljak uspostavlja dodatne i specifične zahtjeve kojima mora udovoljiti operator koji poduzima komercijalne operacije koje nisu komercijalni zračni prijevoz, kako bi se osiguralo odvijanje operacija zrakoplova u skladu sa člankom 8. i Aneksom IV »Bitni zahtjevi za letačke operacije« Uredbe 216/2008 koja je sadržana u Dodatku Pravilnika o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa.
...
(c) Podnositelji zahtjeva za Svjedodžbu zračnoga operatora, moraju nadležnom tijelu dokazati da su SOP-ovi navedeni u OPS.COM.270 (a) i (b) prikladni za operacije koje se namjeravaju izvoditi.
...
(a) Helikopteri kojim se izvode operacije u naseljenom prijateljskom okruženju mora:
...
Članovi posade koji nisu članovi letačke posade moraju biti vezani kada izvode specijalizirane zadatke sa otvorenim ili uklonjenim vratima.
...
Svaki član posade mora nositi odijelo za preživljavanje kada se operacije izvode iznad vode ili iznad vode izvan auto-rotacijske udaljenosti/jedrenja od kopna, gdje, u slučaju nezgode, postoji mogućnost slijetanja na vodu, i kada vremenski izvještaji ili prognoze dostupne zapovjedniku ukazuju da će temperatura mora za vrijeme leta, biti niža od 10o C.

OPS.COM.465.A Sustav indikacije mape terena i upozoravanja (o opasnom približavanju preprekama) – (TAWS) – Avioni

Bez obzira na zahtjev OPS.GEN.465.A, TAWS može biti onemogućen za vrijeme specifičnih radova iz zraka koji, po svojoj prirodi, zahtijevaju izvođenje operacija u kojima je zrakoplov od zemlje na udaljenosti ispod one koja bi rezultirala aktivacijom TAWS-a, u skladu sa uvjetima certifikata ili specifikacija operatora.
...
OPS.SPA.001.GEN Nadležno tijelo

Bez obzira na OPS.GEN.005, u svrhu ovog Pododjeljka, nadležno tijelo za nekomercijalne operatore koji izvode operacije u PBN/MNPS i RVSM zračnom prostoru, mora biti nadležno tijelo države u kojoj je zrakoplov registriran.

OPS.SPA.005.GEN Područje primjene

Ovaj Sekcija utvrđuje zahtjeve kojima mora udovoljiti operator da bi ishodio izdavanje ili produljenje posebnih operativnih odobrenja.

OPS.SPA.020.GEN Zahtjev za posebno odobrenje

(a) Podnosioci zahtjeva za prvo izdavanje posebnog odobrenja moraju nadležnom tijelu podnijeti dokumentaciju koja se zahtijeva u odgovarajućem Pododjeljku i slijedeće informacije:
...
Područje aktivnosti operatora za koje mu je izdano posebno odobrenje mora biti navedeno u operativnom priručniku i u operativnim specifikacijama Svjedodžbe operatora zrakoplova.
...
(ii) sastav posade i zahtjeve vezane za iskustvo;
...
(a) Dodatno uz opremu zahtijevanu prema OPS.GEN, zrakoplov uključen u LVO mora biti opremljen s radio visinomjerom.
...
(a) Za određivanje visine odluke mora se koristiti radio visinomjer.
...
(2) da je stanje vizualnih i ne-vizualnih sredstava zadovoljavajuće prije započinjanja uzlijetanja sa smanjenom vidljivošću, prilaza uz korištenje EVS-a, prilaza s nižim minimumima od standardne kategorije I, prilaza koji nije standardni prilaz kategorije II ili prilaza kategorije II ili III.
...
(iii) Zahtjevima za posebno izvješćivanje u slučaju nesreće ili događaja koji ugrožava sigurnost kada se prevoze opasne robe;
...
Operacije bez osigurane sposobnosti za sigurno prisilno slijetanje mogu se izvoditi samo u slijedećim slučajevima:
...
(1) uspostaviti i održavati dodatno, uz zahtjeve sadržane u Part OR.OPS, specifične programe obuke i provjeravanja za članove posade uključene u te operacije; i
...
PART OR – ORGANIZACIJSKI ZAHTJEVI
Pododjeljak OPS – Zrakoplovne operacije

Sekcija I – Opći zahtjevi

OR.OPS.005.GEN Područje primjene

Ovaj pododjeljak uspostavlja dodatne zahtjeve kojima mora udovoljavati operator:

(a) Koji obavlja nekomercijalne operacije složenim zrakoplovom na motorni pogon;

(b) Da bi udovoljio uvjetima za izdavanje ili produžavanje svjedodžbe zračnoga operatora za izvođenje komercijalnih operacija.
...
(d) Praćenje podataka o letu (FDM): proaktivna i nekažnjavajuća upotreba digitalnih podataka sa leta iz ustaljenih operacija u svrhu unaprjeđenja sigurnosti u zrakoplovstvu

(e) Ugovor o zakupu zrakoplova bez posade (Dry lease agreement): ugovor između poduzetnika kad se zrakoplov koristi u skladu s AOC-om zakupoprimca.

(f) Ugovor o zakupu zrakoplova s posadom (Wet lease agreement): ugovor između komercijalnih operatora imatelja važećega AOC-a u skladu sa Pravilnikom o uslađivanju tehničkih propisa i upravnih postupaka u području civilnog zrakoplovstva, i Pravilnikom o zahtjevima zajedničkih zrakoplovnih vlasti i upravnim postupcima koji se primjenjuju na komercijalni zračni prijevoz helikopterom kad se zrakoplov koristi pod AOC-om zakupodavca.

OR.OPS.100.GEN Odgovornosti operatora

(a) Operator je odgovoran za operacije zrakoplova u skladu sa člankom 8. i Aneksom IV »Bitni zahtjevi za letačke operacije« Uredbe 216/2008 koja je sadržana u Dodatku Pravilnika o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa, PART-om OPS ovoga Pravilnika, primjenjivim pododjeljcima ovoga Dodatka i svojom izjavom i svjedodžbom.
...
(d) Praćenje podataka o letu (FDM): proaktivna i nekažnjavajuća upotreba digitalnih podataka leta iz ustaljenih operacija u svrhu unaprjeđenja sigurnosti u zrakoplovstvu

(e) Ugovor o zakupu zrakoplova bez posade (Dry lease agreement): ugovor između poduzetnika kad se zrakoplov koristi u skladu s AOC-om zakupoprimca.

(f) Ugovor o zakupu zrakoplova s posadom (Wet lease agreement): ugovor između komercijalnih operatora imatelja važećega AOC-a u skladu sa Pravilnikom o usklađivanju tehničkih propisa i upravnih postupaka u području civilnog zrakoplovstva, i Pravilnikom o zahtjevima zajedničkih zrakoplovnih vlasti i upravnim postupcima koji se primjenjuju na komercijalni zračni prijevoz helikopterom kad se zrakoplov koristi pod AOC-om zakupodavca.

OR.OPS.105.GEN Zrakoplovi koji se koriste u komercijalnim i nekomercijalnim operacijama

Kada se zrakoplovom izvode komercijalne i nekomercijalne operacije, operativne specifikacije za komercijalne operacije moraju sadržavati dodatak za izvođenje nekomercijalnih operacija, a i operativni priručnik mora sadržavati operativne postupke koji se koriste u slučaju nekomercijalnih operacija.

Sekcija II – Priručnici, dnevnici i zapisi

OR.OPS.015.MLR Operativni priručnik

(a) Operator mora uspostaviti operativni priručnik (Operations Manual – OM) koji sadrži sve neophodne upute, informacije i postupke, uključujući standardne operativne postupke i programe osposobljavanja i nastavnim planom za svo osoblje koje je uključeno u operacije za izvršavanje njihovih dužnosti i za zrakoplov kojim se izvode operacije.

(b) Sadržaj OM-a mora odražavati zahtjeve postavljene u ovom Partu i Partu OPS, i ne smije biti u suprotnosti sa uvjetima sadržanima u operativnim specifikacijama svjedodžbe i izjave operatora.
...
(g) Imatelji svjedodžbe zračnoga operatora, moraju imati odobrenje nadležnoga tijela za OM i njegove izmjene.
...
(g) Operator mora objaviti operativne i postupke održavanja povezane sa MEL-om kao dio OM-a ili MEL-a. Operator mora:
...
OR.OPS.025.MLR Operativni plan leta – komercijalni zračni prijevoz jedrilicama i balonima

Operativni plan leta mora biti napravljen za svaki planirani let, te mora biti utemeljen na razmatranju performansi zrakoplova, drugim operativnim ograničenjima i primjenjivim očekivanim uvjetima na ruti kojom se kreće i dotičnim aerodromima, osim za letačke operacije danju iznad ruta gdje je navigacija sa korištenjem vizualnih obilježja na zemlji.

OR.OPS.030.MLR Informacije koje ostaju na zemlji – komercijalni zračni prijevoz jedrilicama i balonima

Informacije koje se odnose na let i prikladne vrsti operacija moraju biti sačuvane na zemlji za vrijeme trajanja svakog leta ili serije letova, osim za operacije danju iznad ruta gdje je navigacija sa korištenjem vizualnih obilježja na zemlji, kada se koriste drugi načini za zabilježavanje informacija na zemlji.
...
(2) Specifična dokumentacija o NOTAM/AIS ukoliko je ona mijenjana od strane operatora;
...
(6) Izvještaj(e) sa leta za bilježenje detalja o događajima ili bilo kojega događaja za koje zapovjednik zrakoplova smatra da treba izvijestiti/zabilježiti.
...
Sekcija III – Izjava i svjedodžba operatora zrakoplova

OR.OPS.040.DEC Izjava i svjedodžba operatora zrakoplova

(a) Prije početka izvođenja operacija, operator mora nadležnom tijelu izjaviti svoju sposobnost i način prijenosa odgovornosti povezanih sa nekomercijalnim operacijama složenoga zrakoplova na motorni pogon.

(b) Kada se upravljanje nekomercijalnim operacijama složenim zrakoplovom na motorni pogon povjerava trećoj strani uime vlasnika, tada ta treća strana mora izjaviti svoju sposobnost i načine prijenosa odgovornosti povezanih sa operacijama zrakoplova nadležnom tijelu.

(c) Operacije se ne smiju započeti prije nego što se izjava zamijeni svjedodžbom zračnoga operatora od strane nadležnog tijela.
...
| Detalji odobrenja (priložiti OPSSPECS): |
...
| Ime i kontakt podaci osobe odgovorne za operacije (ukoliko se razlikuje od odgovornog rukovoditelja): |
| Izjave |
| OM odražava primjenjive zahtjeve na način kako se to zahtijeva PART-om OR i PART-om OPS.  Svi letovi će se obavljati u skladu sa tim OM-om. |
| Svi zrakoplovi kojima se izvode operacije imaju važeću Svjedodžbu o plovidbenosti u skladu sa PART-om M, i tip zrakoplova je certificiran od strane EASA-e. |
| Svi članovi letačke i kabinske posade (ukoliko je primjenjivo) su osposobljeni u skladu sa PART-om OR. |
...
(a) Prije početka komercijalnih operacija, operator mora podnijeti zahtjev i ishoditi svjedodžbu operatora zrakoplova od strane nadležnoga tijela.
...
(1) Udovoljava svim primjenjivim zahtjevima ovoga PART-a i PART-a OPS;

(2) Svi zrakoplovi kojima se izvode operacije imaju Svjedodžbu o plovidbenosti u skladu sa primjenjivim propisom o certifikaciji zrakoplova te projektnih i proizvodnih organizacija (Part 21);
...
(4) Svaki let može biti izveden u skladu sa odredbama OM-a.

OR.OPS.020.AOC Operativne specifikacije i ovlaštenja imatelja svjedodžbe operatora zrakoplova

(a) Ovlaštenja za koja je operator certificiran moraju biti navedena na operativnim specifikacijama u svjedodžbi.

(b) Ovlaštenja imatelja svjedodžbe zračnoga operatora mogu uključivati bilo koje operacije za koje se zahtijeva specifično odobrenje navedeno u PART OPS.SPA.

OR.OPS.025.AOC Izmjene

U slučaju izmjene svjedodžbe podnositelj mora dostaviti nadležnom tijelu odgovarajuće dijelove OM-a, Organizacijskoga priručnika i svu ostalu relevantnu dokumentaciju.

OR.OPS.030.AOC Zakup

SVAKI ZAKUP

(a) Svaki ugovor o zakupu za zrakoplov registriran u trećoj državi i koji se koristi od strane operatora za koga država članica osigurava nadzor nad operacijama ili koristi u ili izvan Europske Zajednice od strane operatora certificiranoga u skladu sa ovom Sekcijom (operator Europske Zajednice) mora biti prethodno odobreno od nadležnih tijela.

DAVANJE U ZAKUP BEZ POSADE

(b) Svako davanje u zakup zrakoplova bez posade operatora za koga država članica osigurava nadzor nad operacijama, mora biti prethodno odobreno od nadležnih tijela te države.

(c) Za odobrenje iz točke (b) iznad, mora biti udovoljeno sljedećim uvjetima:

(1) Nadležna tijela su prenijele odgovornost za nadzor nad operacijama i održavanjem, nadležnom tijelu zakupoprimca;

(2) Zrakoplov je brisan iz AOC-a zakupodavca; i

(3) Zrakoplov se održava prema odobrenom Programu održavanja zrakoplova.

OR.OPS.201.AOC Praćenje podataka o letu – avioni

(a) Operator mora uspostaviti i održavati Program praćenja podataka o letu, koji mora biti sastavni dio sustava upravljanja za avione sa MTOM većom od 27000 kg.

(b) Program praćenja podataka o letu mora biti nekažnjavajući i sadržavati prikladne obrambene mehanizme za zaštitu izvora podataka.
...
(3) Nadzor članova posade i osoba koje su uključene u operacije mora biti vršen od strane osoba sa prikladnim iskustvom i vještinama kako bi se osigurala razina standarda definirana u OM-u.
...
Kada je zasebna pozicija za inžinjera leta uključena u konstrukciju aviona, letačka posada mora uključivati jednog člana posade koji je odgovarajuće osposobljen u skladu s primjenjivim nacionalnim propisima.
...
Poglavlje 3
Dodatni zahtjevi za komercijalne operacije koje nisu komercijalni zračni prijevoz
...
(a) Članovi kabinske posade mogu biti raspoređeni na dužnost u zrakoplov samo ako su:
...
(3) Dodatno osim predmeta specifičnih za tip zrakoplova određenih, OR.OPS.CC i ovim poglavljem pokriti najmanje slijedeće teme kako odgovara tipu zrakoplova ili varijanti na kojoj će član kabinske posade obavljati dužnost:
...
(b) Svakih 12 kalendarskih mjeseci član kabinske posade mora proći periodičko osposobljavanje usklađeno s OR.OPS.CC i ovim poglavljem koje pokriva najmanje slijedeće teme za svaki tip zrakoplova ili varijantu na kojoj će član kabinske posade obavljati dužnost:
...
(6) Analiza događaja i nesreća bitnih za operatora;
...
(c) Pored tema osposobljavanja navedenih u (b), članovi kabinske posade moraju također biti osposobljeni u slijedećem, unutar vremenskih intervala koji ne prelaze 3 godine:
...
(b) Član kabinske posade koji nije obavljao letačke dužnosti na jednom određenom tipu zrakoplova tijekom prethodnih 6 mjeseci mora, prije nego je određen za obavljanje dužnosti na tom tipu, završiti jedno od sljedećeg:
...
(3) su povremeno podvrgnuti liječničkom pregledu, temeljenom na najboljoj praksi zrakoplovne medicine, da bi sigurno obavljali dodijeljene dužnosti.

(4) imaju završena sva školovanja zahtijevana u ovoj sekciji, za obavljanje dodijeljenih dužnosti; i

(5) im je provjerena stručnost za obavljanje dodijeljenih dužnosti.
...
Sekcija VIII – Zahtjevi ograničenja vremena dužnosti, vremena letenja i odmora

Poglavlje 1
Općenito

OR.OPS.005.FTL Područje primjene

Ova sekcija postavlja zahtjeve kojima mora udovoljiti operator u komercijalnim operacijama koje nisu komercijalni zračni prijevoz, u nekomercijalnim operacijama složenim zrakoplovom na motorni pogon, te ostali operatori koji izvode operacije za potrebe traganja i spašavanja, osposobljavanja za stjecanje dozvola privatnih, profesionalnih i prometnih pilota, operacija u poljoprivredi, kako bi kontrolirao umor i udovoljio zahtjevima i ograničenjima vremena dužnosti, letenja i odmora za članove posade (letačke, kabinske i tehničke posade).

OR.OPS.010.FTL Definicije

Za potrebe ove sekcije primjenjivat će se ove definicije:

(a) Cirkadijski period: vrijeme između 02:00 i 05:59 sati. Unutar tri vremenske zone odnosi se na vrijeme u domaćoj bazi (home base time). Izvan te tri vremenske zone, a za prvih 48 sati nakon odlaska iz vremenske zone domaće baze, cirkadijski period se referira na vrijeme u domaćoj bazi, a nakon tih 48 sati na lokalno vrijeme u mjestu dolaska.

(b) Član letačke posade: pilot, inženjer leta ili navigator određen za dužnosti u zrakoplovu.

(c) Član posade na dužnosti: član posade koji izvršava svoje dužnosti u zrakoplovu tijekom leta.

(d) Domaća baza: lokacija koju članovima posade odredi operator, gdje članovi posade obično započinju i završavaju vrijeme dužnosti ili seriju vremena dužnosti, i gdje u normalnim uvjetima operator zrakoplova nije dužan osigurati smještaj članovima posade.

(e) Dužnost: svaki zadatak koji član posade mora izvršiti na zahtjev operatora, uključujući primjerice letačke dužnosti, administrativne poslove, obuku, pozicioniranje i pripremu kada postoji vjerojatnost pojave umora.

(f) Lokalna noć: period od 8 sati koji pada između 22:00 sata i 08:00 sati po lokalnom vremenu.

(g) Lokalni dan: period od 24 sata koji započinje u 00:00 sati po lokalnom vremenu.

(h) Pozicioniranje: prijevoz člana posade zrakoplova koji nije na operativnoj dužnosti, iz mjesta u mjesto po nalogu operatora isključujući vrijeme polaska od kuće do određenog mjesta javljanja i obrnuto ili vrijeme lokalnog prijevoza od mjesta odmora do mjesta početka dužnosti i obrnuto.

(i) Proširena letačka posada: letačka posada koja uključuje više od najmanjeg broja letačke posade potrebne za operiranje zrakoplovom i unutar koje svaki član posade može napustiti dodijeljenu poziciju i biti zamijenjen odgovarajuće kvalificiranim članom letačke posade u svrhu odmora tijekom leta.

(j) Slobodni dan: vrijeme oslobođeno od svih dužnosti koje uključuje jedan dan i dvije lokalne noći koje može uključiti i vrijeme odmora kao dio slobodnog dana.

(k) Vrijeme dežurstva: vrijeme tijekom kojega se od člana posade zrakoplova zahtijeva da bude na raspolaganju operatoru kako bi primio obavijest o rasporedu na određenu dužnost bez prekida odmora u međuvremenu.

(l) Vrijeme dužnosti: vrijeme koje počinje kada operator zatraži člana posade da se javi da započne dužnost i završava u trenutka kada je osoba potpuno slobodna od svih dužnosti.

(m) Vrijeme letačke dužnosti: vrijeme koje započinje kada se od član posade zahtijeva da se javi na dužnost što uključuje let ili seriju letova, i koji završava kada se zrakoplov potpuno zaustavi i motori isključe ili rotori zaustave na kraju zadnjeg leta na kojem su oni bili članovi posade.

(n) Vrijeme letenja predstavlja:

(1) Za avione i motorne jedrilice: ukupno vrijeme od trenutka kada se zrakoplov prvi puta pokrene sa parkirne pozicije u svrhu uzlijetanja da trenutka kada se potpuno zaustavi na određenoj parkirnoj poziciji nakon leta i svi motori ili propeleri se zaustave.

(2) Za helikoptere: ukupno vrijeme kada se pokrenu rotori u svrhu uzlijetanja do trenutka kada se helikopter potpuno zaustavi nakon leta i rotori se zaustave.

(3) Za jedrilice: ukupno vrijeme od trenutka kada jedrilica započne zatrčavanje u svrhu uzlijetanja do trenutka kada se potpuno zaustavi na kraju leta.

(4) Za balone: ukupno vrijeme od trenutka kada se košara odvoji od zemlje u svrhu uzlijetanja do trenutka kada se balon potpuno zaustavi nakon leta.

(o) Vrijeme odmora: određen i neprekinut period vremena nakon i/ili prije vremena dužnosti tijekom kojega je član posade zrakoplova slobodan od svih dužnosti.

OR.OPS.015.FTL Odgovornost operatora

Operator mora gdje je to primjenjivo na vrstu operacija:

(a) objaviti raspored dužnosti dovoljno unaprijed da osigura mogućnost članovima posade planiranje odgovarajućeg odmora;

(b) odrediti domaću bazu za svakog člana posade zrakoplova;

(c) osigurati da je vrijeme letačke dužnosti planirano tako da omogući članovima posade da budu odmorni, kako bi mogli obavljati dužnosti za zadovoljavajućoj razini sigurnosti u svim okolnostima;

(d) odrediti vrijeme javljanja na dužnost da osigura dovoljno vremena za dužnosti na zemlji;

(e) uzeti u obzir vezu između učestalosti i strukture vremena letačke dužnosti i vremena odmora pri čemu treba voditi računa o efektu nakupljanja umora zbog dugotrajne dužnosti u kombinaciji sa minimalnim vremenom odmora.

(f) dodijeliti raspored dužnosti koji izbjegava praksu koja uzrokuje ozbiljno ometanje uspostavljenog ritma spavanje/rad kao što je naizmjenična dan/noć dužnost,

(g) osigurati vrijeme odmora dovoljno da članovi posade nadvladaju učinke prijašnje dužnosti i budu dobro odmoreni prije sljedećeg perioda dužnosti,

(h) planirati slobodne lokalne dane i o tome, dovoljno unaprijed, obavijestiti članove posade,

(i) osigurati obrok i piće da se izbjegne bilo koji štetan utjecaj na učinak posade,

(k) osigurati da se planira da letovi završe unutar dozvoljenog perioda letačke dužnosti, vodeći računa o vremenu potrebnom za dužnosti tijekom pripreme leta,vremenu leta i vremenu provedenom na zemlji između letova zrakoplova,

(l) poduzimati radnje za promjene u rasporedu posada kada trenutne operacije premašuju najduži period letačke dužnosti na, značajnom dijelu letova, u tom rasporedu tijekom perioda planirane sezone.

OR.OPS.020.FTL Zapisi vremena letenja, dužnosti i odmora

(a) Nekomercijalni operatori složenih zrakoplova na motorni pogon, te ostali operatori koji izvode operacije za potrebe traganja i spašavanja, osposobljavanja za stjecanje dozvola privatnih, profesionalnih i prometnih pilota, operacija u poljoprivredi, moraju voditi zapise za sve članove posade vezano za njihovo vrijeme letenja, letačke dužnosti i vremena odmora.

(b) Komercijalni operatori moraju voditi osobne zapise vezano uz zaposlenost svih članova posade o njihovom vremenu letenja, letačke dužnosti i vremenu odmora kako slijedi:

(1) zapise o vremenu letenja, dužnosti i odmora, uključujući;

(i) vrijeme letenja;

(ii) početak, trajanje i kraj svakog vremena dužnosti ili vremena letačke dužnosti;

(2) Zapise kako je predviđeno u skladu s točkom (c) i OPS.GEN.020. članova posade koji obavljaju dužnosti za više od jednog operatora za period od 15 mjeseci;

(3) Zapise zapovjednika o produženju vremena letačke dužnosti, produženju vremena letenja i skraćenju vremena odmora za period od 6 mjeseci.

(c) Na zahtjev, operator mora nadležnom tijelu osigurati kopiju individualnog zapisa o vremenu letenja, vremenu letačke dužnosti i vremenu odmora:

(1) za člana posade na kojeg se odnosi;

(2) drugom operatoru za člana posade koji je ili će postati član posade tog drugog operatora.

OR.OPS.025.FTL Sustav upravljanja rizikom kod umora (FRMS)

(a) Operator mora uspostaviti, primijeniti i održavati FRMS kao sastavni dio sustava upravljanja. FRMS mora osigurati da su postignuti sigurnosni ciljevi u skladu sa bitnim zahtjevima Pravilnika o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa.

(b) FRMS mora biti prilagođen za upravljanje rizikom operacija operatora koji proizlazi iz umora posade.

(c) FRMS mora odgovarati sustavu rasporeda ili planu vremena letenja koju koristi operator sukladno s OR.OPS.230.FTL ili OR.OPS.330.FTL.

(d) Operator mora tražiti od članova posade da prijave situaciju ako su umorni i sigurnost može biti ugrožena.

(e) Operator mora primijeniti mjere za smanjenje utjecaja na sigurnost kada FRMS proces pokaže da zahtijevana razina sigurnosti nije održana.

OR.OPS.035.FTL Vrijeme letačke dužnosti (FDP)

(a) Operator mora uspostaviti procedure kojima će zapovjednik, u slučaju posebnih okolnosti koje mogu voditi do teškog umora, nakon konzultacije sa uključenim članovima posade, smanjiti vrijeme letačke dužnosti (FDP) i/ili povećati vrijeme odmora da bi otklonio svaki škodljiv utjecaj na sigurnost leta.

(b) Operator mora zahtijevati da zapovjednik ispuni izvješće svaki puta kada je FDP produžen njegovom odlukom, ili je smanjenje vremena odmora smanjeno za vrijeme izvođenja operacije. U slučaju kada je produženje FDP-a ili smanjenje vremena odmora veće od jednog sata, operator mora poslati kopiju zapisa zajedno sa njegovim komentarima nadležnom tijelu, ne kasnije od 28 dana nakon događaja.

OR.OPS.040.FTL Vrijeme letenja i vrijeme na dužnosti

Zahtjevi ograničenja vremena letenja i vremena na dužnosti moraju odrediti sljedeće elemente vremena letenja i vremena na dužnosti, gdje je primjenjivo na vrste operacija:

(a) Ukupno vrijeme dužnosti za koje je član posade određen, raspoređeno ravnomjerno kako je izvediivo kroz određeni period dužnosti:

(1) u bilo kojih sedam uzastopnih dana; i

(2) u bilo kojih 28 uzastopnih dana;

(b) Ukupno vrijeme letenja letova na koje je pojedini član posade raspoređen kao operativna posada, raspoređeno ravnomjerno kako je izvedivo kroz određeni period dužnosti:

(1) u bilo kojih 28 uzastopnih dana; i

(2) u bilo kojih uzastopnih 12 kalendarskih mjeseci.

OR.OPS.045.FTL Pozicioniranje

Kada operator odredi člana posade za pozicioniranje, sljedeće se mora primjenjivati, uzimajući u obzir vrstu operacija:

(a) Pozicioniranje nakon što se prijavi, ali prije izvođenja operacija, mora biti uključeno kao dio FDP ali se ne smije računati kao sektor.

(b) Sve vrijeme provedeno u pozicioniranju mora se računati kao vrijeme dužnosti i mora se uzeti u obzir za računanje minimalnog vremena odmora.

OR.OPS.050.FTL Vrijeme dežurstva

Kada operator odredi članu posade vrijeme dežurstva, sljedeće se mora uzeti u razmatranje kada je primjenjivo na vrstu operacija:

(a) Dežurstvo na aerodromu/operativnoj površini u cijelosti se mora računati u svrhu izračuna ukupnog vremena dužnosti;

(b) Dežurstvo na aerodromu/operativnoj površini koje se odmah nadovezuje na vrijeme letačke dužnosti, mora se dodati na vrijeme dužnosti i mora se računati u svrhu izračuna minimalnog vremena odmora;

(c) Dežurstvo na aerodromu/operativnoj površini koje se neće nastaviti određivanjem na letačku dužnost mora se nastaviti određenim vremenom odmora;

(d) Članovima posade na dežurstvu na aerodromu/operativnoj površini mora se osigurati tiho i udobno mjesto nedostupno javnosti.

Poglavlje 2
Nekomercijalni operatori složenih zrakoplova na motorni pogon

OR.OPS.230.FTL Zahtjevi ograničenja vremena letenja, vremena dužnosti i odmora za nekomercijalne operatore složenih zrakoplova na motorni pogon

(a) Nekomercijalni operatori složenih zrakoplova na motorni pogon moraju uspostaviti, implementirati i primjenjivati ograničenja primjenjiva za vrijeme letenja, vrijeme letačke dužnosti, vrijeme dužnosti i vrijeme odmora za članove posade.

(b) Da bi udovoljili zahtjevima pod (a), nekomercijalni operatori složenih zrakoplova na motorni pogon moraju ili:

(1) uspostaviti, primjenjivati i održavati sustav rasporeda, određujući sljedeće elemente gdje je primjenjivo na vrstu operacija:

(i) broj sektora

(ii) prelazak vremenskih zona

(iii) gubitak spavanja

(iv) narušavanje cirkadijskih ciklusa

(v) noćne sate

(vi) pozicioniranje

(vii) ukupno vrijeme dužnosti za dani period vremena

(viii) podjele dužnosti između članova posade

(ix) planiranja proširenja posada; ili

(2) koristiti certificirane specifikacije objavljene od Europske agencije za sigurnost zračnog prometa gdje je primjenjivo za tip operacija; ili

(3) koristiti odobrene planove vremena letenja koji odgovaraju tipu operacija.

(c) Ograničenje vremena letenja, vremena dužnosti i odmora koji primjenjuju nekomercijalni operatori složenih zrakoplova na motorni pogon moraju biti sadržani u operativnom priručniku i moraju biti podržani odgovarajućim operatorovim sustavom upravljanja umorom (FRMS) kako je opisano u OR.OPS.025.FTL da bi se upravljalo operativnim rizicima.

Poglavlje 3
Komercijalni operatori

OR.OPS.320.FTL Zapisi o vremenu letenja, dužnosti i odmora

Komercijalni operatori moraju voditi pojedinačne zapise vezane uz angažman svih članova posade koji se odnose na njihovo vrijeme letenja, dužnosti i odmora kako slijedi:

(a) Zapise vremena letenja, dužnosti i odmora za period od 15 mjeseci:

(1) vrijeme letenja;

(2) početak, trajanje i završetak svakog perioda dužnosti ili letačke dužnosti; i

(3) vrijeme odmora i slobodne dane;

(b) izvješća zapovjednika o produženju vremena letačke dužnosti, produženju vremena letenja i skraćenju vremena odmora za period od 6 mjeseci.

OR.OPS.325.FTL Sustav upravljanja rizicima umora (FRMS)

FRMS komercijalnih operatora mora sadržavati sljedeće komponente, gdje je primjenjivo na tip, obim i složenost operacija i odgovarajući plan vremena letenja:

(a) politiku upravljanja rizicima umora;

(b) programe obuke i informiranosti;

(c) procese otkrivanja, izvješćivanja, istraživanja i upravljanja rizicima umora;

(d) procese praćenja zamora posade;

(e) procese izvješćivanja, istraživanja i zapisivanja nezgoda koji mogu potpuno ili djelomično biti povezani s umorom.

(f) FRMS povratne informacije i mehanizme za prilagodbu.

OR.OPS.330.FTL Odrednice za planiranje vremena letenja

(a) Komercijalni operatori moraju uspostaviti, primjenjivati i voditi detaljne planove prilagođene tipovima operacija.

(b) Da udovolji zahtjevima pod (a) komercijalni operator mora uporabiti:

(1) Detaljne odrednice za planiranje vremena letenja sadržane u certificiranim specifikacijama koje je objavila Europska agencija za sigurnost zračnog prometa: ili

(2) Pojedinačne odrednice za planiranje vremena letenja koje prethodno odobrava nadležno tijelo.

(c) Kada podnosi zahtjev za odobrenje pojedinačnih odrednica za planiranje vremena letenja operator mora dokazati nadležnom tijelu sukladnost s Pravilnikom o zajedničkim pravilima u području civilnog zrakoplovstva i nadležnostima Europske agencije za sigurnost zračnog prometa i pridruženim provedbenim pravilima.

Pri podnošenju zahtjeva, operator mora dostaviti nadležnom tijelu potpun opis pojedinačnih detaljnih odrednica za planiranje vremena letenja, uključujući izmjene priručnika ili postupaka koje mogu biti primjenjive kao i potrebnu dokumentaciju. Takva dokumentacija mora:

(1) uzimati u obzir operativno iskustvo i najbolju praksu;

(2) uzeti u obzir sva primjenljiva ograničenja vremena letenja i dužnosti i zahtijeva za vremenom odmora;

(3) uključi detaljan opis sustava upravljanja rizicima umora (FRMS)

(4) uključiti procjenu rizika

(5) biti podržana procjenama baziranima na trenutnim znanstvenim principima i znanju;

(6) uključiti detalje vezane uz konzultacije sa zainteresiranim stranama.

(d) Pojedinačne odrednice za planiranje vremena letenja opisane u (c) moraju sadržavati sustav rasporeda članova posade uključujući sljedeće elemente:

(1) Vrijeme letačke dužnosti (FDP) sukladno OR.OPS.035.FTL i OR.OPS.335.FTL;

(2) Vrijeme letenja i vrijeme dužnosti sukladno OR.OPS.040.FTL;

(3) Dužnost pozicioniranja sukladno OR.OPS.045.FTL gdje je primjenjivo na tip operacija;

(4) Dužnost dežurstva sukladno OR.OPS.050.FTL i OR.OPS.350.FTL gdje je primjenjivo na tip operacija;

(5) Vrijeme odmora sukladno OR.OPS.055.FTL i OR.OPS.355.FTL.

OR.OPS.335.FTL Vrijeme letačke dužnosti (FDP)

Odrednice za planiranje vremena letenja komercijalnih operatora moraju odrediti sljedeće elemente FDP-a gdje je primjenjivo na tip operacija:

(a) Najduži osnovni dnevni FDP

(b) Smanjenja najdužeg osnovnog dnevnog FDP-a ovisno o broju sektora;

(c) Smanjenja najdužeg osnovnog dnevnog FDP-a kada bi on počeo, završio ili uključio cirkadijski period (WOCL)

(d) Uvjete za produženje najdužeg vremena osnovnog dnevnog FDP-a uzimajući u obzir:

(1) broj sektora koji se preleti;

(2) FDP unutar WOCL-a;

(3) Najveći broj povećanja uzastopnih dana;

(4) produženje najkraćeg vremena odmora prije i poslije leta;

(5) dužnosti na zemlji tijekom pojedinačnog FDP-a;

(6) najmanji broj odmora tijekom leta dodijeljenog svakom članu posade, i

(7) povećanje osnovnog broja članova posade.

(e) uvjete pod kojima zapovjednik može FDP, vrijeme letenja i vrijeme dužnosti produžiti ili vrijeme odmora skratiti nakon konzultacija sa svim članovima posade, u slučaju nepredviđenih okolnosti i trenutnim letačkim operacijama, nakon javljanja na dužnost i postupke za izvješćivanje o tim promjenama.

OR.OPS.350.FTL Vrijeme dežurstva

(a) Odrednice za planiranje vremena letenja za komercijalne operacije moraju navesti sljedeće dijelove za vrijeme dežurstva, gdje je primjenjivo za tip operacija:

(1) određivanje maksimalne dužine bilo kojeg vremena dežurstva,

(2) odnos između vremena dežurstva i dodijeljenih letačkih dužnosti tijekom vremena dežurstva, uzimajući u obzir raspoloživu infrastrukturu za odmor letačke posade i ostale odgovarajuće uvjete,

(3) određivanje vremena odmora nakon vremena dežurstva koje se ne nastavlja određivanjem na letačku dužnost,

(4) Kako se vrijeme dežurstva uračunava u ukupno vrijeme dužnosti.

(b) Kada komercijalni operatori određuju članovima posade vrijeme dežurstva, sljedeće mora biti razmotreno uzimajući u obzir tip operacija:

(1) Vrijeme dežurstva mora biti planirano i članovi posade na koje se odnosi moraju biti obaviješteni unaprijed,

(2) Vrijeme početka i završetka vremena dežurstva mora biti određeno i članovi posade na koje se odnosi moraju biti obaviješteni unaprijed,

(3) vrijeme dežurstva na aerodromu/operativnoj površini počinje u trenutku kada se član posade prijavi na određenoj točci za javljanje na dužnost i mora završiti kako je planirano.

OR.OPS.355.FTL Vrijeme odmora

Odrednice za planiranje vremena letenja za komercijalne operatore moraju odrediti sljedeće elemente odmora, gdje je primjenjivo na vrste operacija:

(a) Minimalno vrijeme odmora vezano uz proteklo vrijeme dužnosti koje mora biti osigurano prije preuzimanja letačke dužnosti koje počinje u domaćoj bazi ili van nje,

(b) mogućnost spavanja prije preuzimanja letačke dužnosti udaljeno od domaće baze ovisno o prethodnom vremenu dužnosti,

(c) dodatno vrijeme odmora da se kompenziraju utjecaji razlike vremenskih zona i produženja FDP-a,

(d) tjedno produženo vrijeme odmora za oporavak da se kompenzira nakupljeni umor.

Poglavlje 4
Dodatni zahtjevi za izvođenje operacija za potrebe traganja i spašavanja, osposobljavanja za stjecanje dozvola privatnih, profesionalnih i prometnih pilota, operacija u poljoprivredi

OR.OPS.605.FTL Ograničenja vremena letenja za potrebe potrage i spašavanja
...
OR.OPS.610.FTL Ograničenja vremena letenja prilikom osposobljavanja za stjecanje dozvola privatnih, profesionalnih i prometnih pilota

(1) Ukupno vrijeme leta instruktora letenja prilikom osposobljavanja za stjecanje dozvola privatnih, profesionalnih i prometnih pilota tijekom 24 sata smije iznositi najviše 8 sati, pri čemu radno vrijeme smije trajati najviše 12 sati tijekom 24 sata.
...
OR.OPS.615.FTL Ograničenja vremena letenja u poljoprivredi
...
(4) Ukupno vrijeme leta u svakih uzastopnih 7 dana ne smije prelaziti 28 sati, s time da tijekom 30 uzastopnih dana iznosi najviše 85 sati, odnosno 900 sati tijekom 12 uzastopnih mjeseci.

Sekcija IX – Zaštita

OR.OPS.025.SEC Program i obuka zaštite

(a) Operator složenih zrakoplova na motorni pogon mora razviti i primjenjivati program zaštite. Program zaštite mora udovoljavati odgovarajućim zahtjevima nacionalnog programa zaštite zračnog prometa nadležnoga tijela države operatora. Odgovarajući elementi programa zaštite moraju biti uključeni u operativni priručnik. Operator mora osigurati da članovi posade posjeduju znanje i stručnost o svim važnim elementima programa zaštite.

(b) Komercijalni operatori i nekomercijalni operatori složenih zrakoplova na motorni pogon moraju uspostaviti, održavati i primjenjivati obuku zaštite koja:

(1) omogućuje članovima posade da postupaju na najprihvatljiviji način da spriječe djela nezakonitog ometanja i da umanje posljedice takvih događaja ako se dogode.

(2) uključuje obuku zaštite vezanu uz neprihvatljivo ponašanje putnika i nezakonitog ometanja.

OR.OPS.030.SEC Lista provjere za postupke pretraživanja zrakoplova

(a) operator složenih zrakoplova na motorni pogon mora na zrakoplovu imati listu provjere koja sadrži postupke koji se moraju slijediti pri traženju bombe ili improviziranih eksplozivnih naprava (IED) u slučaju kada se sumnja u sabotažu i za pregled zrakoplova zbog skrivenog oružja, eksploziva ili opasnih naprava kada postoji osnovana sumnja da zrakoplov može biti predmet nezakonitog ometanja.

(b) Lista provjere mora biti podržana postupcima koji osiguravaju naputke za odgovarajuće radnje koje se moraju poduzeti ako se nađe bomba ili sumnjivi predmet i ako je nositelj certifikacije tipa osigurao informaciju o mjestu najmanjeg rizika od bombe za određeni zrakoplov.

OR.OPS.035.SEC Zaštita pilotske kabine – avioni

U svim složenim avionima na motorni pogon i u svim avionima koji se koriste u komercijalnim operacijama, koji su opremljeni vratima pilotske kabine, ta vrata moraju imati mogućnost zaključavanja i moraju biti osigurana sredstva kojima kabinska posada može diskretno izvijestiti letačku posadu u slučaju sumnjivih aktivnosti ili narušavanja sigurnosti u kabini.

OR.OPS.040.SEC Zaštita pilotske kabine – helikopteri

Ako su ugrađena vrata na pilotskoj kabini helikoptera kojim se izvode operacije u svrhu prijevoza putnika, ona moraju imati mogućnost zaključavanja iz pilotske kabine da se spriječi neovlašteni ulaz.
