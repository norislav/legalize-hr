...
identifier: "HR-NN-2021-42-828"
country: "hr"
rank: "pravilnik"
publication_date: "2021-04-21"
last_updated: "2021-04-21"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2021/42/828"
act_number: "828"
...
transposes_eu_directive: "http://data.europa.eu/eli/reg/2014/1388/oj"
---
...
g) »Poduzetnik u sektoru ribarstva i akvakulture« – svaki subjekt koji djeluje u proizvodnji, preradi i stavljanju na tržište proizvoda ribarstva i akvakulture, bez obzira na njegov pravni oblik
...
i) »Povlastica za gospodarski ribolov na moru (u daljnjem tekstu: povlastica za ribolov)« – isprava na temelju koje se smije obavljati gospodarski ribolov na moru

j) »Radni dan« – svaki dan koji nije subota, nedjelja ili blagdan odnosno svaki dan kad Uprava ribarstva radi
...
Predmet potpore je dodjela državne potpore u ribarstvu (u daljnjem tekstu: potpora), a kao pomoć za otklanjanje ozbiljnih poremećaja u gospodarstvu uslijed epidemije koronavirusa u sektoru gospodarskog ribolova na moru.
...
a) korisnik mora biti ovlaštenik važeće povlastice za ribolov izdane za ribarsko plovilo u segmentu malog priobalnog ribolova iz članka 2. stavka 1. točke e) ovoga Pravilnika, koje mora biti u funkciji, a što se dokazuje važećim dokumentima

b) korisnik na dan 31. prosinca 2019. godine ne smije biti poduzetnik u teškoćama iz članka 2. stavka 1. točke h) ovoga Pravilnika

c) iznimno od točke b) ovoga stavka, ako je korisnik mikro ili malo poduzeće, potpora se može dodijeliti ako je korisnik već bio u teškoćama na dan 31. prosinca 2019. godine, pod uvjetom:
...
d) korisnik mora imati zabilježen pad prihoda u 2020. godini od minimalno 20% u odnosu na 2019. godinu

e) korisnik mora dati suglasnost za objavljivanje informacija o dodijeljenoj potpori u skladu sa točkom 88. Privremenog okvira i Prilogom III. Uredbe (EU) br. 1388/2014.

(2) Uz uvjete za korisnika iz stavka 1. ovoga članka, moraju biti ispunjeni i sljedeći uvjeti za ribarsko plovilo iz stavka 1. točke a) ovoga članka:

a) ribarsko plovilo mora pripadati u segment malog priobalnog ribolova iz članka 2. stavka 1. točke e) ovoga Pravilnika

b) uz zadovoljavanje uvjeta iz točke a) ovoga stavka, u slučaju okružujućih mreža plivarica – srdelara, ribarsko plovilo mora biti autorizirano u tome segmentu ribolova

c) ribarsko plovilo mora imati dostatnu minimalnu ribolovnu aktivnost od ukupno 40 ribolovnih dana ostvarenih u kalendarskoj godini (od 1. siječnja do 31. prosinca prethodne godine) koja prethodi godini podnošenja Zahtjeva za potporu

d) ribarsko plovilo mora ostvariti minimalni iskrcaj od 100 kg provedenih kroz prodajne listove i/ili fiskalne račune u kalendarskoj godini koja prethodi godini podnošenja Zahtjeva za potporu

e) fiskalni računi iz točke d) ovoga stavka odnose se isključivo na račune kada su riba i/ili drugi morski organizmi prodani direktno sa plovila krajnjem potrošaču.

(3) Neprihvatljivi su Zahtjevi za potporu ako je korisnik:
...
(1) Korisnik je dužan djelovati u skladu s uvjetima iz članka 4. stavka 3. ovoga Pravilnika tijekom razdoblja dodjele potpore te, ako se tijekom tog razdoblja utvrdi da korisnik ne poštuje pravila zajedničke ribarstvene politike, potpora se vraća razmjerno težini povrede.
...
(2) Sredstva potpore iz stavka 1. ovoga članka iznose ukupno 15.000.000,00 kuna.

(3) Potpora iznosi jednokratno 6.000,00 kuna po zaposlenom djelatniku.

(4) Zaposleni djelatnik mora biti zaposlenik kod korisnika u trenutku podnošenja Zahtjeva za potporu.

(5) Zaposleni djelatnik iz stavka 3. ovoga članka podrazumijeva i vlasnika obrta.

(6) Član posade koji je zaposlen za obavljanje poslova na ribarskom plovilu koje ne udovoljava uvjetima iz članka 4. stavka 2. ovoga Pravilnika se ne smatra zaposlenim djelatnikom iz stavka 3. ovoga članka.

(7) U slučaju korisnika koji uz gospodarski ribolov na moru iz članka 3. ovoga Pravilnika obavlja i drugu djelatnost u okviru te izvan sektora ribarstva i akvakulture iz članka 2. stavka 1. točke m) ovoga Pravilnika, zaposleni djelatnik iz stavka 3. ovoga članka podrazumijeva isključivo onog djelatnika koji u ukupnom radnom vremenu obavlja poslove vezane uz korisnikovu djelatnost gospodarskog ribolova, a što se potkrjepljuje odgovarajućom dokumentacijom.

(8) Ukupan iznos potpore jednom poduzetniku na temelju ovoga Pravilnika te Pravilnika o uvjetima, kriterijima i načinu dodjele državne potpore u ribarstvu za pomoć gospodarstvu – COVID-19 (»Narodne novine«, broj 53/20) ne smije prelaziti 270.000,00 eura.

(9) Potpora se dodjeljuje po jednom poduzetniku.

(10) Sukladno članku 2. stavku 2. Uredbe Komisije (EU) br. 717/2014 pojmom »jedan poduzetnik« obuhvaćena su sva poduzeća koja su u najmanje jednom od sljedećih međusobnih odnosa:
...
b) u slučaju kada utvrđena nepravilnost ujedno predstavlja i utvrđenu sumnju na prijevaru. Odlukom o povratu sredstava Uprava ribarstva će zahtijevati od korisnika povrat ukupno isplaćenih sredstava potpore, te će o istome izvijestiti Državno odvjetništvo Republike Hrvatske.
...
(1) U slučaju da je korisniku izdana Odluka o povratu sredstva, iznimno od članka 12. stavka 4. ovoga Pravilnika korisnik može iznos duga vratiti u obrocima, ako o tome obavijesti Upravu ribarstva u roku od petnaest dana od dana zaprimanja Odluke o povratu sredstava.
