...
identifier: "HR-NN-2009-20-439"
country: "hr"
rank: "pravilnik"
publication_date: "2009-02-13"
last_updated: "2009-02-13"
status: "in_force"
source: "https://narodne-novine.nn.hr/eli/sluzbeni/2009/20/439"
...
Na temelju članka 115. stavak 4. Zakona o proračunu (»Narodne novine« broj 87/08), ministar financija donosi
...
Proračunski nadzor postupak je nadziranja zakonitosti, svrhovitosti i pravodobnosti korištenja proračunskih sredstava kojim se nalažu mjere za otklanjanje utvrđenih nezakonitosti i nepravilnosti.
...
(1) Proračunski nadzor obuhvaća pregled i provjeru računovodstvenih, financijskih i ostalih poslovnih dokumenata subjekata nadzora, nadzor namjenskog korištenja proračunskih sredstava svih pravnih i fizičkih osoba kojima su doznačena sredstva iz proračuna i financijskih planova izvanproračunskih korisnika te kreditnih sredstava s osnove jamstva države i jedinica lokalne i područne (regionalne) samouprave.
...
2. poduzimanje korektivnih mjera radi zaustavljanja nepravilnosti i prijevara kao što su zlouporaba proračunskih sredstava, pogrešno upravljanje, te određivanje mjera za popravak štete koja je već nastala u proračunu,

3. provjera pravilnosti primjene zakona te na temelju zakona donesenih propisa i akata,

4. prikupljanje pouzdanih i vjerodostojnih financijskih i drugih podataka te njihovo pravodobno dostavljanje nadležnim tijelima.

III. DJELOKRUG I SADRŽAJ PRORAČUNSKOG NADZORA

### Članak 7.

(1) Proračunski nadzor obavlja se radi provjere pravilnosti korištenja proračunskih sredstava te primjene zakona i drugih propisa.
...
(3) Provjerom primjene zakona i drugih propisa, u smislu stavka 1. ovoga članka, smatra se provjera primjene zakona i drugih propisa koji su u izravnoj ili neizravnoj vezi s korištenjem proračunskih sredstava.
...
(2) Zapisnik iz stavka 1. ovoga članka sastavlja se u četiri (4) primjerka. Po jedan primjerak zapisnika dostavlja se odgovornoj osobi subjekta nadzora, njegovoj unutarnjoj reviziji i Državnom uredu za reviziji, a jedan primjerak zapisnika ostaje ustrojstvenoj jedinici za proračunski nadzor.
...
(5) Po zaključenju zapisnika, inspektor proračunskog nadzora obvezan je sastaviti sažetak zapisnika koji dostavlja ministru financija, nadležnom državnom tajniku i glavnom državnom rizničaru.
...
(1) U slučaju utvrđenih nepravilnosti kod subjekta nadzora koji je po organizacijskoj klasifikaciji proračuna u sastavu razdjela odnosno glave, zapisnik o obavljenom proračunskom nadzoru dostavlja se nadležnom razdjelu odnosno glavi.
...
(4) Ako su proračunskim nadzorom utvrđene nepravilnosti za koje nisu propisane kazne, inspektor proračunskog nadzora nalaže mjere za otklanjanje nepravilnosti.
...
(3) Izvješće iz stavka 1. ovoga članka čelnik ustrojstvene jedinice za proračunski nadzor dostavlja u roku od 30 dana po isteku razdoblja na koje se izvješće odnosi ministru financija, nadležnom državnom tajniku i glavnom državnom rizničaru.

VIII. PRIJELAZNE I ZAVRŠNE ODREDBE

### Članak 18.

Danom stupanja na snagu ovoga Pravilnika prestaje važiti Pravilnik o proračunskom nadzoru (»Narodne novine« broj 79/08).

### Članak 19.

Ovaj Pravilnik stupa na snagu osmoga dana od dana objave u »Narodnim novinama«.

Klasa: 041-01/09-01/6
